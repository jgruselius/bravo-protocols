...
<Velocity11 file='Protocol_Data' md5sum='7770d0799c68f99a682486f5f8e7b3f4' version='2.0' >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Position 4 will be set to 85C.  The protocol will not continue until the temperature gets within 5 degrees.

Place the black PCR plate carrier at position 4 as well to warm.  The PCR plate will be transfered here in a few steps.' />
...
//set head mode using number of columns
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (formProtocolName != undefined) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Warm Buffer 2' />
						<Parameter Category='' Name='Body' Value='Confirm that buffer 2 is at position 6 and the Nunc with prepared beads is at position 5.

Place tips in racks 1 and 2 of BenchCel and an empty tip box at cassette 4, slot 1.

And confirm these plates are in the miniplatehub (slot 1 is at the bottom):

Cassette 1, slot 4 - Eppendorf plate for elution
                 slot 3 - Eppendorf plate for wash

Cassette 3, slot 4 - Elution buffer
                 slot 3 - Buffer 1

Cassette 4, slot 3 - Neutralization buffer' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer Hyb. Soln' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer Hyb. Soln' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Hyb PCR plate' />
  ...
  var need_tips = 0
   ...
   {task.skip()
    print(&quot;Tip box still has space.&quot;)
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Empty Tips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
tips_off_loc = 13' />
			...
			<Pipette_Process Name='Transfer Hyb. Soln' >
				<Minimized >0</Minimized>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Hyb PCR plate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;Waiting for position 4 to reach 85 degrees C&quot;)
...
' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Add Hyb Plate' />
						<Parameter Category='' Name='Body' Value='Complete the following steps as quickly as possible:

Retrieve Hybridization plate from thermocycler, and place on carrier at Bravo position 4 and unseal.
...
*Use Caution: Position 4 will be hot.' />
				...
				<Task Name='Bravo::secondary::Wait For User' Task_Type='1024' >
					...
					<Parameters >
						<Parameter Category='' Name='User Message' Value='Please press the Go button to continue' />
					</Parameters>
					<PipetteHead AssayMap='0' Disposable='1' HasTips='1' MaxRange='251' MinRange='-41' Name='96LT, 200 킠 Series III' >
						<PipetteHeadMode Channels='0' ColumnCount='12' RowCount='8' SubsetConfig='0' SubsetType='0' TipType='0' />
					</PipetteHead>
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Hyb PCR plate' />
						<Parameter Category='' Name='Location, location' Value='4' />
						<Parameter Category='Volume' Name='Volume' Value='34' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='//to initially mix beads and hyb

//for real run use 10 Mix Cycles
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Update Bravo Deck' />
						<Parameter Category='' Name='Body' Value='Remove PCR plate and carrier from position 4.

Place red aluminum PCR plate insert at position 4 for next protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='1963' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='//long slow mix

//for real run use 25 Mix Cycles
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='//to remove droplets
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Capture Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
print(&quot;Taking tips off at &quot; + task.Wellselection)' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Empty Tips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
//setting mastermix_tips and spri_case variable
mastermix_col = 0
spri_case = 0
