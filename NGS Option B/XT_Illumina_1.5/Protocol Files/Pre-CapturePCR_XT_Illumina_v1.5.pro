...
<Velocity11 file='Protocol_Data' md5sum='11a8dd09c2f36de550394cd9ce264781' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Wait For Temperature' />
						<Parameter Category='' Name='Body' Value='The temperature is being set to 4C at position 6.

This may take a few minutes.  Acknowledge this message to continue.' />
...
print(&quot;Setting position 6 to 4 degrees C, please wait&quot;)
' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Position 6 is set to 4C.

Confirm that appropriate amount of Pre-Capture master mix is in column 4 of a NUNC plate.
...
Place DNA plate at position 7 and master mix plate at position 9.' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Place the Plate to be used for PCR at Cassette 4, slot 5 of mini plate hub.

New Master mix tips with 3 columns missing from the left side go in Cassette 1, slot 1. And a empty used mastermix tip box goes in 1, slot 2.
		...
		<Main_Processes >
			...
			<Pipette_Process Name='Master Mix Addition' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='var precapturepcr_mm = 1' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='precapturepcr_mm++' />
				</Task>
