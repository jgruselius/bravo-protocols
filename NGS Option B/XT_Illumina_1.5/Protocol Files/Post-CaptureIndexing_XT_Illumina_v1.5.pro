...
<Velocity11 file='Protocol_Data' md5sum='64f5ecb16ad767f25a3a1d090f7960da' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_1.5\Device Files\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_1.5\Forms\SureSelectXT_Illumina_v1.5.VWForm' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open(&quot;C:\\VWorks Workspace\\NGS Option B\\XT_Illumina_1.5\\Scripts\\tiptracking.js&quot;)
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='The temperature at position 6 will be set to 4C.  The protocol may pause until the temperature gets within range.
...
Click &apos;Continue&apos; to resume protocol.' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;Setting temperature for position 6 to 4 degrees C, please wait&quot;)' />
					<Parameters >
						...
						<Parameter Category='' Name='Temperature Tolerance' Value='15' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (formProtocolName != undefined) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Labware' />
						<Parameter Category='' Name='Body' Value='Confirm that appropriate amount of Post-Capture master mix is in column 4 of a NUNC plate.

Place DNA plate at position 7 and master mix plate at position 9.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (formProtocolName != undefined) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Other Labware' />
						<Parameter Category='' Name='Body' Value='Place the PCR plate with indexes added already in a carrier  at Cassette 4, slot 5 of mini plate hub.

New Master mix tips  go in Cassette 1, slot 1. And a empty used mastermix tip box goes in 1, slot 2.

Place a new tip box in rack 1 of the Benchcel.

A empty tip box also goes in Cassette 4, slot 1.
...
//set head mode using the number of columns
...
' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mastermix_col = 12' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Wait_for_new_tips' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::Wait For' Waitfor='wait_for_used_tips' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Wait_for_new_tips' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='wait_for_used_tips' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Pipette_Process Name='Master Mix Addition' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='var postcapturepcr_mm = 1
var mm_tip_col = 1' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , mm_tip_col ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Volume' Value='27' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = [[ 1 , postcapturepcr_mm ]]' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='postcapturepcr_mm++
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DNA Plate' />
						<Parameter Category='' Name='Location, location' Value='4' />
						<Parameter Category='Volume' Name='Volume' Value='14' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='4' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 10 - 50ul aq' />
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate ready to seal' />
						<Parameter Category='' Name='Body' Value='Seal PCR plate and run thermocycler protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Remaining tips' />
						<Parameter Category='' Name='Body' Value='If new tips remain, they will be in cassette 4, slot 2  and cassette 1, slot 1 of the MiniPlateHub.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
