...
<Velocity11 file='Protocol_Data' md5sum='11fda29a5c81034f02e8cf728dc8feda' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_1.5_scilife_mod\Device Files\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='1' />
	<Processes >
		<Startup_Processes >
			<Process >
...
Place the destination plate (Eppendorf twin.tec) at position 9.
...
' />
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='The &quot;TESTING ONLY&quot; box is checked.  This protocol has no incubations and/or mix cycles and will not reduce protocol run time.
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Aliquot Libraries' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Aliquot Libraries' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='Aliquot Libraries' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Hit Pick Replication' Task_Type='64' >
					...
					<Parameters >
						...
						<Parameter Category='Built-in Parameters' Name='Source, location' Value='9' />
						<Parameter Category='Built-in Parameters' Name='Destination, plate' Value='Destination' />
						<Parameter Category='Built-in Parameters' Name='Destination, location' Value='5' />
						<Parameter Category='Built-in Parameters' Name='Choose input file at protocol start' Value='1' />
						<Parameter Category='Built-in Parameters' Name='Input file' Value='C:\Users\AAS\Desktop\750ng_transfer_full_plate_template.csv' />
						<Parameter Category='Built-in Parameters' Name='Format file' Value='500ng transfer_twintec.xml' />
						...
						<Parameter Category='Built-in Parameters' Name='Output file' Value='C:\VWorks Workspace\VWorks\Hit Picking\Output Files\HitPickFiles 12_13_2012 11_35_44 AM\HitPick1.csv' />
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;bb2bed247040a335367fd704de70aef8&apos; version=&apos;1.0&apos; &gt;
	&lt;CherryPickTransfers &gt;
		&lt;CherryTransfers &gt;
			&lt;CherryPickTransfer Volume=&apos;5&apos; &gt;
				&lt;SourceWell Column=&apos;0&apos; Row=&apos;1&apos; /&gt;
				&lt;DestinationWell Column=&apos;0&apos; Row=&apos;1&apos; /&gt;
			&lt;/CherryPickTransfer&gt;
		&lt;/CherryTransfers&gt;
	&lt;/CherryPickTransfers&gt;
&lt;/Velocity11&gt;' />
						<Parameter Category='Built-in Parameters' Name='SourcePlateLabware' Value='96 Eppendorf Twin.tec PCR' />
						<Parameter Category='Built-in Parameters' Name='DestinationPlateLabware' Value='96 Eppendorf Twin.tec PCR' />
					...
					<CherryRoutineWizardParams Additional_Ops='0' Auto_Skip_Headings_YesNO='0' Backfill_Destination_Plate='' Backfill_Destination_Plate_Location='' Backfill_HitPickTask='' Backfill_Source_Plate='' Backfill_Source_Plate_Location='' Backfill_Transfer_Params='' Change_Tips_When='1' Change_tip_box='0' Destination_Plate='Destination' Destination_Plate_Column='' Destination_Plate_Location='5' Destination_Well_Col='' Destination_Well_ID_YesNO='0' Destination_Well_Row='' Destination_Well_Row_Col_YesNO='0' Dual_Wash='0' Format_File='500ng transfer_twintec.xml' Hit_Pick_Transfer_Params='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;75664c7246d0a157425f0f22365e503e&apos; version=&apos;1.0&apos; &gt;
	&lt;ModuleObjectDescription &gt;
		...
		&lt;/Categories&gt;
	&lt;/ModuleObjectDescription&gt;
&lt;/Velocity11&gt;' Input_At_Start='1' Input_File='' Num_Wash_Cycles_Every_Transfer='1' Number of Columns in the Input File='4' Skip_Heading_Lines_Num='1' Source_Plate='Source' Source_Plate_BC='None' Source_Plate_Column='1' Source_Plate_Location='9' Source_Well_Col='' Source_Well_ID_Column='2' Source_Well_ID_YesNO='1' Source_Well_Row='' Source_Well_Row_Col_YesNO='0' Start_From_Transfer_Num='1' Variable_Dilution_Factor_Column='' Variable_Transfer_Volume_Column='4' Version='1.0' Wash_When='0' Will_Mix='0' Will_Mix_Before='0' >
						<MixPreAsp >
...
&lt;/Velocity11&gt;' />
										...
										<Parameter Category='Pump' Description='Check this option to turn the pumps off during the dispense' Name='Turn pumps off during dispense' Scriptable='1' Style='0' Type='0' Value='0' />
