...
<Velocity11 file='Protocol_Data' md5sum='a1a5873708f682ca5a6cf22571d3822a' version='2.0' >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Position 4 will be set to 69C.  The protocol will not continue until the temperature gets within 5 degrees.

Place the red adaptor block at position 4 as well to warm.  The PCR plate will be transfered here in a few steps.' />
...
Cassette 1, slot 3 - Eppendorf plate for wash

Cassette 3, slot 3 - Wash buffer 1' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
Retrieve Hybridization plate from thermocycler, and place in block at Bravo position 4 and unseal.
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Removethe Eppendorf plate from position 4.

Leave red aluminum insert at position 4 for next protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='158' />
					</Advanced_Settings>
