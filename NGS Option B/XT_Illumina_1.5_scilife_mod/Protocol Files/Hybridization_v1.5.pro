...
<Velocity11 file='Protocol_Data' md5sum='8bcabd03506b66f97cc65cf61ac59602' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_1.5_scilife_mod\Device Files\BravoMiniPHBenchCel_round_magnet_red4.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_1.5_scilife_mod\Forms\SureSelectXT_Illumina_v1.5.VWForm' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open(&quot;C:\\VWorks Workspace\\NGS Option B\\XT_Illumina_1.5_scilife_mod\\Scripts\\tiptracking.js&quot;)
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Setting Temperature' />
						<Parameter Category='' Name='Body' Value='After acknowledging this message, position 4 will be set to 69C.  There may be a pause for a few minutes while the position 4 comes to temperature.' />
...
//get head mode parameters for subprocesses
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (formProtocolName != undefined) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Set temperature' />
						<Parameter Category='' Name='Body' Value='Confirm that appropriate amount of master mix is in the following columns of the master mix plate:
Column 1 - Blocker mix.
Column 2 - Capture Library.
Column 3 - Hyb Buffer.

Place DNA plate at position 5, Eppendorf PCR plate at position 6, and master mix plate (Eppendorf) at position 9.

Place empty tip boxes at position 8 of the Bravo and cassette 1 slot 2 of the Mini Plate Hub.

Place new tips in the BenchCel, rack 1.
' />
						<Parameter Category='' Name='Only show the first time' Value='' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer Block Mix Transfer' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer Block Mix Transfer' />
					</Parameters>
				</Task>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer Capture Library' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer Capture Library' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer Hybe Buffer' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer Hybe Buffer' />
					</Parameters>
				</Task>
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Reagent  Plate' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Mix DNA and Blockers' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Mix DNA and Blockers' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Signal' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_1_1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_2' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='PCR Plate' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
single_col_tips_on = 0
single_col_tips_off  = 0' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if( tip_box_to_Spawn == &quot;tips2&quot;)
   {
    print(&quot;Spawning tips2.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of tips2.&quot;)
   }' />
					<Parameters >
   ...
   {
    print(&quot;Spawning tips4.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of tips4.&quot;)
   }' />
					<Parameters >
   ...
   {
    print(&quot;Spawning tips5.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of tips5.&quot;)
   }' />
					<Parameters >
   ...
   {
    print(&quot;Placing &quot; + plate.name + &quot; at position 8&quot;);
   }
else
   {
    task.skip();
   print(&quot;Skipping place at position 8.&quot;);
   }' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//tips1 will become emptytips2 if tips1 is empty

if (isEmpty())
   {
    print(plate.name + &quot; becomes emptytips2&quot;);
   }
else
   {
    task.skip();
   print(&quot;Skipping spawn of emptytips2&quot;);
   }' />
					<Parameters >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//if there are tips remaining, tip box will become tips2

if (!isEmpty())
   {
    print(plate.name + &quot; will become tips2.&quot;);
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of tips2.&quot;);
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//if all tips are used tips1, need to get full box from stacker

if (isEmpty())
   {
    print(&quot;Spawning new tips from stacker for tips2&quot;);
    tip_box_to_Spawn = &quot;tips2&quot;
   }
else
   {
    task.skip();
   print(&quot;Skipping spawn of TipControl.&quot;);
   }' />
					<Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//if used tip box is not full, it becomes empty tips2

if(!isFull())
   {
    print(&quot;Spawning emptytips2.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of emptytips2.&quot;)
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//completely filled used tips get upstacked

if(isFull())
   {
    print(&quot;Spawning upstack of &quot; + plate.name + &quot;.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping upstack of &quot; + plate.name + &quot;.&quot;)
   }' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='UpstackUsedTips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Load' >
					...
					<TaskScript Name='TaskScript' Value='//becomes used tip box if empty

if (isEmpty())
   {
    task.loadIntoByLocation = [&quot;Cassette4Slot1&quot;]
    print(plate.name + &quot; becomes next used tip box.  Loading into Mini plate hub Cassette 4 slot 1.&quot;)
   }
else
   {
    task.loadIntoByLocation = [&quot;Cassette4Slot2&quot;]
   print(plate.name + &quot; will be stored in Cassette 4 slot 2 for tips4.&quot;)
   }
...
print(&quot;Loading plate into &quot; + task.loadIntoByLocation)' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//upstack if full
...
else
   {
    ...
    print(&quot;Skipping upstack of &quot; + plate.name + &quot;.&quot;)
				...
				<Task Name='BuiltIn::Load' >
					...
					<TaskScript Name='TaskScript' Value='//store in miniplatehub if not full

if(!isFull())
   {
    print(&quot;Loading &quot; + plate.name + &quot; into Miniplatehub.&quot;)
   }
else
   {
    task.skip()
    print(&quot;Skipping load of &quot; + plate.name + &quot; into Miniplatehub.&quot;)
   }' />
					<Parameters >
						<Parameter Category='' Name='loadIntoByLocation' Value='' />
						<Parameter Category='' Name='loadIntoByGroup' Value='' />
...
if (isEmpty())
   {
    print(&quot;Spawning new tips from stacker for tips4&quot;);
...
if (!isEmpty())
   {
    print(&quot;Spawning unload of new tips from miniplatehub for tips4&quot;);
   }
else
   {
    task.skip();
   print(&quot;Skipping spawn of unload.&quot;);
   }' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Unload_tips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Unload_emptytips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
   ...
   print(&quot;Skipping place at position 8.&quot;);
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//if tips remain, tip box will move to next subprocess

if (!isEmpty())
   {
    print(plate.name + &quot; becomes tips5&quot;);
   }
else
   {
    task.skip();
   print(&quot;Skipping spawn of tips5&quot;);
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//spawn tips from miniplatehub for tips5

if (isEmpty())
   {
    print(plate.name + &quot; becomes emptytips5&quot;);
   }
else
   {
    task.skip();
   print(&quot;Skipping spawn of emptytips5&quot;);
   }' />
					<Parameters >
...
if (isEmpty())
   {
    print(&quot;Spawning TipContol for tips5.&quot;);
   ...
   print(&quot;Skipping spawn of emptytips5&quot;);
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//if tip box is full, upstack
...
else
   {
    ...
    print(&quot;Skipping upstack of &quot; + plate.name + &quot;.&quot;)
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//spawn emptytips5

if(!isFull())
   {
    print(plate.name + &quot; will become emptytips5.&quot;)
   }
else
   {
    task.skip();
    print(&quot;Skipping spawn of emptytips5.&quot;)
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Unload_tips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Unload_emptytips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
tips_off_loc = 13' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='UpstackUsedTips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='Mix DNA and Blockers' >
				<Minimized >0</Minimized>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='DNA Plate' />
				...
				<Task Name='Bravo::secondary::Move To Location' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='8' />
					</Parameters>
					<PipetteHead AssayMap='0' Disposable='1' HasTips='1' MaxRange='251' MinRange='-41' Name='96LT, 200 킠 Series III' >
						<PipetteHeadMode Channels='0' ColumnCount='1' RowCount='8' SubsetConfig='3' SubsetType='3' TipType='0' />
					</PipetteHead>
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
}' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Remove plate ' />
						<Parameter Category='' Name='Body' Value='Remove plate from block, seal and place in thermocycler.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
' />
			...
			<Pipette_Process Name='Transfer Block Mix Transfer' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='var block_mix = 1' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var single_col_tips_on = 0
var single_col_tips_off  = 0' />
				</Task>
...
single_col_tips_off++' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , single_col_tips_on ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='trackNew(1)' />
				</Task>
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reagent  Plate' />
						<Parameter Category='' Name='Location, location' Value='9' />
						<Parameter Category='Volume' Name='Volume' Value='11.6' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = [[ 1 , block_mix ]]' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DNA Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , single_col_tips_off ]]
print(&quot;Taking tips off at &quot; + task.Wellselection)' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='trackUsed(1)' />
				</Task>
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='block_mix++' />
				</Task>
				<Task Name='BuiltIn::Group End' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
			...
			<Pipette_Process Name='Transfer Capture Library' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='var capture = 1' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;d4b0ccac7e9c488ef9b03e8cebe75927&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var single_col_tips_on_2 = 0
var single_col_tips_off_2  = 0' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
single_col_tips_on_2++
single_col_tips_off_2++' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' Value='12' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , single_col_tips_on_2 ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = [[ 1 , capture ]]' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='PCR Plate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , single_col_tips_off_2 ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='capture++' />
				</Task>
				<Task Name='BuiltIn::Group End' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
			...
			<Pipette_Process Name='Transfer DNA' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature Tolerance' Value='5' />
						<Parameter Category='' Name='Timeout' Value='5' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
					</Parameters>
					<PipetteHead AssayMap='0' Disposable='1' HasTips='1' MaxRange='251' MinRange='-41' Name='96LT, 200 킠 Series III' >
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Wait for plate in thermocycler' />
						<Parameter Category='' Name='Body' Value='When thermocycler has reached hold step at 65C, click Continue.

Leave DNA plate in thermocycler until you are prompted to transfer the plate.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='PCR Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='2.5' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='PCR Plate' />
						<Parameter Category='' Name='Location, location' Value='5' />
						<Parameter Category='Volume' Name='Volume' Value='24' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 10 - 50ul aq' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='0.2' />
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Place DNA plate on Bravo' />
						<Parameter Category='' Name='Body' Value='Complete the following steps as quickly as possible:

Retrieve DNA plate from thermocycler, and place on block at Bravo position 4 and unseal.

Click Continue to resume protocol.

*Use Caution: Position 4 will be hot.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
					...
					<TaskScript Name='TaskScript' Value='if(task.isSimulatorRunning())
{
    task.Userdataentryintovariable= 1;
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Remove Plate from 4' />
						<Parameter Category='' Name='Body' Value='Quickly remove plate from position 4, seal and place in thermocycler.

Click Continue after plate is in thermocycler for protocol to finish.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Transfer Hybe Buffer' >
				<Minimized >0</Minimized>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='var hybe = 1' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;d4b0ccac7e9c488ef9b03e8cebe75927&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reagent  Plate' />
						<Parameter Category='' Name='Location, location' Value='9' />
						<Parameter Category='Volume' Name='Volume' Value='13' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='2' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 10 - 50ul aq' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='0.2' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='hybe++' />
				</Task>
				<Task Name='BuiltIn::Group End' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='var remaining_new_tips = 12 - col
print(&quot;The number of columns of remaining new tips is &quot; + remaining_new_tips + &quot;.&quot;)

if(remaining_new_tips &gt; 0)
   {
    task.Title = &quot;Unused Tips&quot;;
    task.Body = &quot;There are still &quot; + remaining_new_tips + &quot; columns of unused tips in the tip box in cassette 4 slot 2.&quot;
   }
else
   {
    task.Title = &quot;Empty Tip box&quot;
    task.Body = &quot;The tip box cassette 4 slot 2 is empty and can be used in other protocols.&quot;
   }

print(&quot;There is also a tip box with new tips in cassette 4 slot 1.&quot;)' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='More unused tips' />
						<Parameter Category='' Name='Body' Value='The tip box in cassette 1 slot 1 contains unused tips as well.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
