...
<Velocity11 file='Protocol_Data' md5sum='23bd73ea80773bceb9831e827cc002be' version='2.0' >
...
print(&quot;Waiting for position 4 to reach 66 degrees C&quot;)' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='66' />
...
Retrieve Hybridization plate from thermocycler, and place on Red insert at Bravo position 4 and unseal.
...
*Use Caution: Position 4 will be hot.' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Hyb PCR plate' />
						<Parameter Category='' Name='Location, location' Value='4' />
						<Parameter Category='Volume' Name='Volume' Value='64' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
' />
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove PCR plate from position 4.

Leave Red Aluminum PCR plate insert at position 4 for next protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='1936' />
					</Advanced_Settings>
