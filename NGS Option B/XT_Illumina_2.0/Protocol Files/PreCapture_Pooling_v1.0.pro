...
<Velocity11 file='Protocol_Data' md5sum='5a8f37e50d10838726def7d4f2ac64fb' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_2.0\Device Files\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='C:\VWorks Workspace\NGS Option B\XT_Illumina_2.0\Forms\SureSelect_XT2_Pooling.VWForm' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open( &apos;C:/VWorks Workspace/NGS Option B/XT_Illumina_2.0/Forms/Supporting Files/InProtocolScripts.js&apos;);
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var formCurrentProtocol = &quot;&quot;
var promptForSources = formPromptForSources
var sealedSources = formSealedSources
var currentSourceWell = &quot;&quot;
var currentSourcePlate = &quot;&quot;
var numberOfWells = &quot;&quot;
var currentDestWell = &quot;&quot;
var currentSourceWellID = &quot;&quot;
var currentDestWellID = &quot;&quot;
var currentSourceWellPosition = &quot;&quot;
var currentDestWellPosition = &quot;&quot;
var currentTransferVolume = &quot;&quot;
var delaySubprocess = true
currentTip = &quot;&quot;
//destPlateType = formPlateType
' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='well_map_96 = well_map_builder(8,12)
...
' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Read in plate data
read_master_file(formMasterInputFile)
print(&quot;Master file read complete&quot;)
create_source_plate_array()
print(&quot;Source Array Created&quot;)
fill_source_plate_array()
print(&quot;Source Array Filled&quot;)' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='numberOfSourcePlates = source_plate.length -1
print(&quot;Number of Source plates = &quot;+numberOfSourcePlates)' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<TaskScript Name='TaskScript' Value='if (promptForSources) task.skip()' />
					<Parameters >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='currentSourcePlate = plate.instance' />
					<Parameters >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='New tips' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (promptForSources) {
	messageTitle = &quot;Add Source Plate&quot;	
	messageText = &quot;Place source plate at Bravo: \n    &quot; + source_plate[currentSourcePlate].barcode +&quot;\n \n&quot;+&quot;Click Continue when plate is unsealed and ready at Bravo Position 3.&quot;
}else if (sealedSources){
	messageTitle = &quot;Unseal Source Plate&quot;	
	messageText = &quot;Unseal source plate on Bravo: \n    &quot; + source_plate[currentSourcePlate].barcode +&quot;\n \n&quot;+&quot;Click Continue when plate is unsealed and ready at Position 3.&quot;
}else task.skip()
task.Title = messageTitle
task.Body = messageText

if (task.isSimulatorRunning) task.Userdataentryintovariable = 1
else task.Userdataentryintovariable = 0' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Unseal Plate' />
						<Parameter Category='' Name='Body' Value='Unseal Source Plate at Bravo Position 3.

Click continue once unsealed plate is returned to Position 3.' />
...
delaySubprocess = false' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer 500ng' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if (plate.instance ==1){
	//Spawn the first used tip box
}else task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Used tips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Numberoftimestoloop = numberOfSourcePlates' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' Value='1' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Source' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='currentDestWell = 0
' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='if (delaySubprocess) task.repeatDelay(20)' />
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
			...
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='currentTip = 0' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='SignalUsedTipsGone' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if (currentSourcePlate == numberOfSourcePlates) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if (plate.instance == numberOfSourcePlates) task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Used tips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='SignalUsedTipsGone' />
					</Waitfors_To_Signal>
				</Task>
			...
			<Pipette_Process Name='Transfer 500ng' >
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Numberoftimestoloop = source_plate[currentSourcePlate].numberOfTransfers' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' Value='96' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = well_map_96[currentTip]
print(&quot;Loading tip number &quot;+currentTip+&quot; at &quot;+task.Wellselection)' />
					<Parameters >
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;e9035583f9479cfb4516bf5e15744744&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; LinkedText=&apos;From hit pick task&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;4&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;0&apos; /&gt;
		&lt;/Wells&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='currentSourceWellID = source_plate[currentSourcePlate].well[currentSourceWell].wellID
currentDestWellID = source_plate[currentSourcePlate].well[currentSourceWell].targetWellID
currentSourceWellPosition = get_well_position(currentSourceWellID)
currentDestWellPosition = get_well_position(currentDestWellID)
currentTransferVolume = source_plate[currentSourcePlate].well[currentSourceWell].volume' />
				</Task>
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = currentSourceWellPosition
task.Volume = currentTransferVolume' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='96 disposable tip 5 - 25ul hit pick' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = currentDestWellPosition
task.Volume = currentTransferVolume' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = well_map_96[currentTip]
print(&quot;Unloading tip number &quot;+currentTip+&quot; at &quot;+task.Wellselection)
currentTip++' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;1dc261ffc9e4b227de934736984d2c4f&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; LinkedText=&apos;From hit pick task&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;4&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='currentSourceWell++' />
				</Task>
				<Task Name='BuiltIn::Loop End' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if (promptForSources) {
	messageTitle = &quot;Seal Source Plate&quot;	
	messageText = &quot;Seal source plate on Bravo: \n    &quot; + source_plate[currentSourcePlate].barcode +&quot;\n \n&quot;+&quot;Click Continue when plate is sealed and ready at Bravo Position 9.&quot;
}else if (sealedSources){
	messageTitle = &quot;Seal Source Plate&quot;	
	messageText = &quot;Seal source plate on Bravo: \n    &quot; + source_plate[currentSourcePlate].barcode +&quot;\n \n&quot;+&quot;Click Continue when plate is sealed and ready at Bravo Position 9.&quot;
}else task.skip()
...
if (task.isSimulatorRunning) task.Userdataentryintovariable = 1
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Seal Source Plate at Bravo Position 9.

Click continue once sealed plate is returned to Position 9.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='if (currentSourcePlate == numberOfSourcePlates) task.skip()
else if (source_plate[currentSourcePlate].numberOfTransfers &lt; 96) {
    // run task
}else task.skip()' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Spawn control' Value='Do not spawn new plates' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='New tips' />
						<Parameter Category='' Name='Spawn control' Value='Do not spawn new plates' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='Used tips' />
						<Parameter Category='' Name='Spawn control' Value='Do not spawn new plates' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
