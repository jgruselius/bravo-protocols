...
<Velocity11 file='Protocol_Data' md5sum='08374bee7790b73aeeef7902a8b72e68' version='2.0' >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Reservationtime = (testMode) ? 1 : 5 * 60;' />
					<Parameters >
