...
<Velocity11 file='Protocol_Data' md5sum='334854007f324c79d59d876cf2df597e' version='2.0' >
...
var beadVol = global.purif.beadVolume || 90;
...
var mPreAspVolume = preAspLarge;
var mTransferVolume = sampleVol + beadVol + 10;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferSample' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var bindMixVol = 0.8 * (beadVol + sampleVol);
