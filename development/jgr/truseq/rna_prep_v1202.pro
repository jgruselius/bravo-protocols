...
<Velocity11 file='Protocol_Data' md5sum='26b7ffa6d2a9274cbe582fc43158e28f' version='2.0' >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='102' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
...
Seal and keep on ice or in fridge until used.' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='398' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='390' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Return plate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='542' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Return plate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='4727' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Return plate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='96' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate transfer' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_frag);
task.Dynamictipretraction = 4 / (0.9 * (vol_frag));
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_elute);
task.Dynamictipretraction = 4 / (0.9 * (vol_elute));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_elute' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_elute + vol_bind);
task.Liquidclass = &quot;j_slow_medium_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_rebind' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_elute + vol_bind);
task.Dynamictipretraction = 4 / (0.9 * (vol_elute + vol_bind));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_rebind' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_synth1 + vol_frag);
task.Liquidclass = &quot;j_slow_medium_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_synth1_b' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_synth1 + vol_frag);
task.Dynamictipretraction = 4 / (0.9 * (vol_synth1 + vol_frag));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_synth1_b' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_synth1 + vol_synth2);
task.Liquidclass = &quot;j_slow_medium_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_synth2_b' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * (vol_synth1 + vol_synth2);
task.Dynamictipretraction = 4 / (0.9 * (vol_synth1 + vol_synth2));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_synth2_b' />
