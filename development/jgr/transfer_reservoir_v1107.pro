...
<Velocity11 file='Protocol_Data' md5sum='01b0bd1201c24ecc2217529d2646366d' version='2.0' >
...
var vol_final =  parseInt(global.formVolume);
var vol_max_asp = 175;
var vol_pre_asp = 30;
var num_cols = parseInt(global.formColumns);
var head_mode = &quot;1,2,1,&quot; + num_cols;
var liquid_class = (global.formLiquidClass == &quot;Slow&quot;) ? &quot;j_peg_handling&quot; : &quot;j_fast_large_vol&quot;; 
var vol_step;
var asp_repeats;

// Debug:
print(&quot;vol_final=&quot;+vol_final+&quot; num_cols=&quot;+num_cols+&quot; liquid_class=&quot;+liquid_class); ' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='EmptyTips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1, 13 - num_cols]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='asp_repeats = Math.ceil((vol_final + vol_pre_asp) / vol_max_asp);
vol_step = vol_final / asp_repeats;

print(&quot;Transfering in &quot; + asp_repeats + &quot; x &quot; + vol_step + &quot; uL steps&quot;);' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=asp_repeats;' Value='1' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = vol_step;
task.Liquidclass = liquid_class;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reservoir' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1, 13 - num_cols]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EmptyTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
