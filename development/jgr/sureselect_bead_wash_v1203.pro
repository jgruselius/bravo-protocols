...
<Velocity11 file='Protocol_Data' md5sum='56f92dbf930faad67155578aa86657c7' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Columns' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var columns = parseInt(userEntry);
var beadVolume = 50;
var washVolume = 200;
var washes = 3;
