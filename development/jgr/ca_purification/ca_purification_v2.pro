...
<Velocity11 file='Protocol_Data' md5sum='e644ad01e9dd8ddd11ec470b3685c6ce' version='2.0' >
...
var columnsOfSamples = parseInt(global.formColumns);
// The headmode used throughout:
var headMode = &quot;1,2,1,&quot; + columnsOfSamples;
// Bead volume:
var beadVolume = parseFloat(global.formBeadVolume);
// Volume to resuspend washed beads in:
var beadResuspVolume = parseFloat(global.formResuspVolume);
// Max aspiration volume:
var maxAspVolume = 170;
// Max volume to use when mixing:
var maxMixVolume = 150;
// Volume for washing bead source plate:
var plateWashVolume = 300;
// Volume used when washing 
// away bead storage buffer:
var beadWashVolume = 120;
// Volume used when washing 
// DNA-bead complex:
var dnaWashVolume = 400;
// Volume elution buffer to rinse tips with:
var rinseVolume = 80;
// Precipitation buffer volume:
var precipVolume = parseFloat(global.formPrecipVolume);
// Sample volume:
var sampleVolume = parseFloat(global.formSampleVolume);
// Magnet incubation time, long
// Used when pelleting fragsep and adjusted so that
// larger volumes have longer pellet time:
var pelletTimeLong = 120 * ((((precipVolume+sampleVolume+beadResuspVolume)/160) + 1) / 2);
// Magnet incubation time:
var pelletTime = 60;
// Magnet incubation time, short:
var pelletTimeShort = 30;
// Incubation time for bead binding:
var bindTime = parseFloat(global.formBindTime) * 60 * timeMod;
// Elution buffer volume:
var elutionVolume = parseFloat(global.formElutionVolume);
// Elution incubation time:
var elutionTime = 2 * 60 * timeMod;
// Temperature of finished sample plate:
var finalTemperature = 10;
// Pre-aspiration volume:
var preAsp = 20;
// Number of times to perform the bead
// storage buffer removal wash:
var beadWashRepeats = 1;
// Number of times to repeat the wash of
// the DNA-bead complex:
var dnaWashRepeats = 1;
// The number of times to mix when washing:
var dnaWashMixes = 5;
// Transfer loop vars:
var stepVolume;
var aspRepeats;
// Bind mix vars:
// Incubation time for air-drying wash buffer:
var ethanolDryTime = 10 * 60;
...
global.statusString = &quot;Setting temperature...&quot;;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='/*
 Declaration of variables TEST VERSION
*/
...
var roomTemperature = 20;
// Number of columns with samples:
var columnsOfSamples = 3;
// The headmode used throughout:
var headMode = &quot;1,2,1,&quot; + columnsOfSamples;
// Bead volume:
var beadVolume = 50;
// Volume to resuspend washed beads in:
var beadResuspVolume = 10;
// Max aspiration volume:
var maxAspVolume = 170;
// Max volume to use when mixing:
var maxMixVolume = 150;
...
// Volume used when washing 
// DNA-bead complex:
var dnaWashVolume = 380;
// Volume elution buffer to rinse tips with:
var rinseVolume = 80;
// Precipitation buffer volume:
var precipVolume = 100;
// Sample volume:
var sampleVolume = 50;
// Magnet incubation time, long
// Used when pelleting fragsep and adjusted so that
// larger volumes have longer pellet time:
var pelletTimeLong = 12 * ((((precipVolume+sampleVolume+beadResuspVolume)/160) + 1) / 2);
// Magnet incubation time:
var pelletTime = 10;
// Magnet incubation time, short:
var pelletTimeShort = 5;
// Incubation time for bead binding:
var bindTime = 2 * 60 * timeMod;
// Elution buffer volume:
var elutionVolume = 30;
// Elution incubation time:
var elutionTime = 2 * 60 * timeMod;
// Temperature of finished sample plate:
var finalTemperature = 10;
...
var aspRepeats;
// Incubation time for air-drying wash buffer
var ethanolDryTime = 5 * 60;
// Panel temperature for wash buffer evaporation:
var dryTemperature = 50;
// For displaying status:
global.statusString = &quot;Setting temperature...&quot;;' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// DEBUG
var vars = [global.statusString,
				columnsOfSamples,
				headMode,
				sampleVolume,
				beadVolume,
...
print(vars);' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' TaskParameterScript='=dryTemperature;' Value='20' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=roomTemperature;' Value='20' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Protocol started&quot;;' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='BeadStirUp' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='RinsePlate' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='BeadSampleResusp' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='BeadSampleResusp' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='signalShakerCleared' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='BeadPlate' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='signalShakerCleared' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='FragSepPlate' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='WashBufferPlate' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='AddElutionBuffer' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Adding elution buffer&quot;;' />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// To try to eliminate beads left in tips,
// perform an extra large preasp:
var extraPreAsp;
if((elutionVolume + preAsp) &gt; 130) {
   extraPreAsp = 180 - elutionVolume - preAsp;
   if(extraPreAsp &lt; 0) {
      extraPreAsp = 0;
   }
} else {
...
task.Volume = preAsp + extraPreAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ElutionBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = elutionVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * elutionVolume;
if(mixVolume &gt; (maxMixVolume - extraPreAsp)) {
	mixVolume = maxMixVolume - extraPreAsp;
}
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='BeadDistribution' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Distributing beads&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='// Column 1:
task.Headmode = &quot;1,2,1,1&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='// Column 12:
task.skip()
task.Wellselection = [[1,12]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Tipbox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;22661f8e3cb8dba834c3454d52c3ef02&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Preaspiration
task.Volume = preAsp;
var currentColumn = 1;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=columnsOfSamples;' Value='' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = beadVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,currentColumn]];
task.Volume = beadVolume;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='currentColumn++;' />
				</Task>
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='// Blowout
task.Volume = preAsp;
task.Wellselection = [[1,columnsOfSamples]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='BeadSampleResusp' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Resuspending beads&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = beadResuspVolume;
task.Preaspiratevolume = preAsp;
task.Postaspiratevolume = 3;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ElutionBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = beadResuspVolume + sampleVolume + 3;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
						<Parameter Category='Properties' Name='Liquid class' Value='j_peg_handling' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='2' />
						<Parameter Category='Properties' Name='Dynamic tip retraction' Value='0' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='South/North' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * (beadResuspVolume + sampleVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='//task.skip();
task.Wellselection = [[1, 13 - columnsOfSamples]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Tipbox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='BeadStirUp' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * (beadVolume * columnsOfSamples);
if(mixVolume &gt; maxMixVolume) {
	mixVolume = maxMixVolume;
}
task.Volume = mixVolume;' />
					<Parameters >
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='South/North' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='3' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;e361f4abaf03a381270fef6afe792f5c&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Bind' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Precipitating DNA&quot;;' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = headMode;
var mWellSelection = [[1,1]];
var mTipSelection = [[1,13-columnsOfSamples]];
var mGetTips = false;
var mReturnTips = false;
var mLiquidClass = &quot;j_extra_slow_mixing&quot;;
var mPreAspVolume = 30;
var mIncubationTime = bindTime;
var mTimerCycles = 5;
var mMixVolume = (precipVolume &lt; maxMixVolume) ? precipVolume : maxMixVolume;
var mAspDistance = 1;
var mDispDistance = 1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = mPreAspVolume;
...
var mTimer = new Date().getTime();
task.Volume = mMixVolume;
task.Liquidclass = mLiquidClass;
task.Mixcycles = mTimerCycles;
task.Aspiratedistance = mAspDistance;
if(mAspDistance !== mDispDistance) {
    task.Dispenseatdifferentdistance = true;
    task.Dispensedistance = mDispDistance;
} else {
    task.Dispenseatdifferentdistance = false;
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='455' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='// Calculate how many mix cycles that corresponds 
// to total incubation time: 
mTimer = (new Date().getTime() - mTimer) / 1000;
var mMixCycles = Math.floor(mTimerCycles*mIncubationTime/(mTimer)) - mTimerCycles;
print(&quot;mTimer=&quot; + mTimer + &quot;, mMixCycles=&quot; + mMixCycles);
if(mMixCycles &gt; 0) {
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Elute' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Eluting&quot;;' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='46' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='// Time n mix cycles to calculate how
// many corresponds to total incubation time: 
var mTimer = new Date().getTime();
task.Volume = mMixVolume;
task.Liquidclass = mLiquidClass;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = extraPreAsp;
task.Distancefromwellbottom = mBlowoutHeight;
task.Liquidclass = &quot;j_blowout&quot;;
if(mDoTipTouch) {
    task.Performtiptouch = true;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='IsolateBeads1' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Removing bead storage buffer&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,13-columnsOfSamples]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Tipbox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = (beadVolume &lt; 120) ? (beadVolume + 20) : (maxAspVolume - beadVolume);
task.Preaspiratevolume = preAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='IsolateBeads3' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Isolating beads&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location to use, location' Value='7' />
						<Parameter Category='' Name='Reservation time' Value='0' />
					</Parameters>
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// To allow larger volumes of precipitation
// buffer than the tip can handle in a single 
// aspiration:
aspRepeats =Math.ceil((precipVolume + sampleVolume + beadResuspVolume + 5) / maxAspVolume);
stepVolume = (precipVolume + sampleVolume + beadResuspVolume) / aspRepeats;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=aspRepeats;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = stepVolume + 5;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='MakeFragSep' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Making fragment separation mixture&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Preasp
task.Volume = preAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='PrecipBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
aspRepeats = 1;
stepVolume = precipVolume;
if(stepVolume &gt; maxAspVolume) {
   aspRepeats = Math.ceil(stepVolume / maxAspVolume);
   stepVolume = Math.round(stepVolume / aspRepeats);
}' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = stepVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='PrecipBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = sampleVolume + beadResuspVolume + 5;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='67' />
					</Advanced_Settings>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='1' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='-8' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6d9e778ac7f7235a77c7705582d38a22&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='RinsePlate' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Rinsing bead source plate&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Each transfer may have to be done in 
// more than one step if volume is large
aspRepeats =Math.ceil((plateWashVolume) / maxAspVolume);
stepVolume = (plateWashVolume) / aspRepeats;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * plateWashVolume;
if(mixVolume &gt; maxMixVolume) {
	mixVolume = maxMixVolume;
}
task.Volume = mixVolume;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Each transfer may have to be done in 
// more than one step if volume is large
// An extra volume is added to handle excess
aspRepeats =Math.ceil((plateWashVolume + 50) / maxAspVolume);
stepVolume = (plateWashVolume + 50) / aspRepeats;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='RinseTips1' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Rinsing tips&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = rinseVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ElutionBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(maxAspVolume - rinseVolume &gt; 0) {
   task.Volume = maxAspVolume - rinseVolume;
} else {
   task.skip();
}' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='30' />
						<Parameter Category='Distance From Well Bottom' Name='Dispense at different distance' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Dispense distance' Value='2' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='RinseTips5' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
			...
			<Pipette_Process Name='TransferEluate' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=finalTemperature;' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = elutionVolume + 5;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume =elutionVolume * 0.9;
task.Dynamictipretraction = 4 / (elutionVolume * 0.9);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FinalPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Tip-surface touch in case drops on tips
task.Volume = preAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FinalPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='WashBeads1' >
				...
				<Task Name='BuiltIn::Group Begin' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Washing beads&quot;;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=beadWashRepeats;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Each transfer may have to be done in 
// more than one step if volume is large
aspRepeats =Math.ceil((beadWashVolume + 5) / maxAspVolume);
stepVolume = beadWashVolume / aspRepeats;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * beadWashVolume;
if(mixVolume &gt; maxMixVolume) {
	mixVolume = maxMixVolume;
}
task.Volume = mixVolume;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='// Return tips so not to interfere with plate moving
task.Wellselection = [[1,13 - columnsOfSamples]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Tipbox' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=dnaWashRepeats;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
...
task.Volume = preAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WashBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Each transfer may have to be done in 
// more than one step if volume is large
aspRepeats =Math.ceil((dnaWashVolume + 5) / maxAspVolume);
stepVolume = dnaWashVolume / aspRepeats;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = 0.7 * dnaWashVolume;
if(mixVolume &gt; maxMixVolume) {
	mixVolume = maxMixVolume;
}
task.Volume = mixVolume;
task.Mixcycles = dnaWashMixes;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FragSepPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='1' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='South/North' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='15' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6d9e778ac7f7235a77c7705582d38a22&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='// Let ethanol evaporate
task.Reservationtime = ethanolDryTime;

global.statusString = &quot;Allowing wash buffer to dry&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='FragSepPlate' />
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Awaiting user confirmation...&quot;;' />
				</Task>
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Temperature reset' />
						<Parameter Category='' Name='Body' Value='The protocol has finished. Remove sample plate from position 4 and confirm to turn off cooling.' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='global.statusString = &quot;Protocol finished&quot;;' />
				</Task>
				<Plate_Parameters >
