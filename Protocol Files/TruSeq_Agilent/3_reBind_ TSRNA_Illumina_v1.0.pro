...
<Velocity11 file='Protocol_Data' md5sum='3273a6c261cf0affea5762b357d5ad15' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Bind Buffer Addition' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Bind Buffer Addition' />
					</Parameters>
				</Task>
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Reagent Plate MH3-4' />
...
task.skip();
				...
				<Task Name='BuiltIn::Incubate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//real time 5 minutes at RT
...
tips_off_loc = 13' />
			...
			<Pipette_Process Name='Bind Buffer Addition' >
				<Minimized >0</Minimized>
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='var atailing_mm = 1' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = [[ 1 , atailing_mm ]]' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reagent Plate MH3-4' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='atailing_mm++' />
				</Task>
