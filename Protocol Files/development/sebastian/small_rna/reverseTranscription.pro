...
<Velocity11 file='Protocol_Data' md5sum='803f09509c02bc9d1039818ab54b70e8' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='1' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\Documents and Settings\joel\Desktop\Bender Device Files\Full_System_Magnet_red6.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var numberOfColumns = parseInt(global.formColumns);
var roomTemp = 22;
var headMode = &quot;1,3,1,&quot; + numberOfColumns;
var preAspVol = 5;
var preAspDist = 30;
var mixCycles = 5;
//Set simulation on/off
var simulationToggle = parseInt(global.simulationToggle);
//Skip timers Yes/No
var timerSkip = parseInt(global.timerSkip);' />
					<Parameters >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='if(simulationToggle == true) {
task.skip();
}
' />
					<Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='SamplePlate2' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer6uLtoNewPlate' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer6uLtoNewPlate' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Recover remaining samples at MiniHub' />
						<Parameter Category='' Name='Body' Value='Recover the remaining 5&apos; and 3&apos; adapter-ligated miRNA at the MiniHub.

This plate may be stored at -80 degrees Celsius.

The robot continues with the preparation for Reverse Transcription.
...
' />
						...
						<Parameter Category='' Name='Pause process' Value='0' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddRTprimer' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddRTprimer' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::User Message' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Denaturate for 2 min' />
						<Parameter Category='' Name='Body' Value='Take the plate from position 6, seal it, then put it on the thermal cycler (with heated lid) and incubate at 70 deg for 2 minutes.

Immediately spin it down, remove the seal, replace it on position 6 and click Continue.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddRTmix' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddRTmix' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::User Message' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Perform Reverse Transcription' />
						<Parameter Category='' Name='Body' Value='Take the plate from position 6, seal it, then put it on a thermal cycler (with heated lid) and incubate at 50 deg for 1 hour.

After incubation, spin down the plate and put it on ice. 

The cDNA is ready to be amplified. 
PCR Mix and indices are manually added before amplification.

Click Continue to finish this protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='SamplePlate2' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='MasterMixPlate' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='NewTips3' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='NewTips3' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='Biometra TRobot::Run a program' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='357' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(timerSkip == true) {
task.skip();
}' />
					<Parameters >
						<Parameter Category='' Name='Block Type' Value='96' />
						<Parameter Category='' Name='Program' Value='4,1,srna-de ' />
						<Parameter Category='Task Description' Name='Task number' Value='2' />
				...
				<Task Name='BuiltIn::CentrifugeAuto' >
					...
					<CustomData >
						<Parameter Name='Spin task id' Value='875205732' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='denaturation' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='Biometra TRobot::Run a program' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='3862' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(timerSkip == true) {
task.skip();
}' />
					<Parameters >
						<Parameter Category='' Name='Block Type' Value='96' />
						<Parameter Category='' Name='Program' Value='4,3,srna-rt ' />
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='Run a program (Biometra TRobot)' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
					</Parameters>
				...
				<Task Name='BuiltIn::CentrifugeAuto' >
					...
					<CustomData >
						<Parameter Name='Spin task id' Value='875354572l' />
						<Parameter Name='Spin task Type' Value='1' />
					</CustomData>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='cDNAsynth' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='AddRTmix' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var headMode = &quot;1,3,1,&quot; + numberOfColumns;
var aspVolume = 5.5;
var tipSelection = [[1,13-numberOfColumns]];
var wellSelection = [[1,1]];
var preAspDist = 30;
var aspDist = 0.5;
var dispDist = 0.75;
var blowOutDist = 6;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=numberOfColumns' Value='numberOfColumns' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables >
						<Variable fIncrement='1' iFreqValue='0' strFrequency='Every time' strInitialValue='1' strVariableName='tipColumn' />
						<Variable fIncrement='1' iFreqValue='0' strFrequency='Every time' strInitialValue='1' strVariableName='dispColumn' />
					</Variables>
				</Task>
...
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='NewTips3' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = preAspDist;
task.Volume = preAspVol;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MasterMixPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;62a72ba3e0e7c4beb67003262a118117&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = aspDist;
task.Volume = aspVolume;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MasterMixPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = dispDist;
task.Wellselection = [[1,dispColumn]];
task.Volume = aspVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate2' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Aspiratedistance = aspDist;
task.Dispensedistance = 4;
task.Wellselection = [[1,dispColumn]];
task.Volume = aspVolume + 3;
task.Mixcycles = mixCycles;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate2' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='0' />
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = blowOutDist;
task.Wellselection = [[1,dispColumn]];
task.Volume = preAspVol;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate2' />
						...
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' TaskParameterScript='=0.75-blowOutDist' Value='0.75-blowOutDist' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;74e9d6ec2462268e981d0ec1413d81db&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='if(numberOfColumns === 12) {
task.skip();
}' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = wellSelection;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='AddRTprimer' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
task.Volume = preAspVol;' />
					<Parameters >
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='1' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' TaskParameterScript='=0.75-blowOutDist' Value='0' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;74e9d6ec2462268e981d0ec1413d81db&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Transfer6uLtoNewPlate' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = tipSelection;
' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = preAspDist;
task.Wellselection = wellSelection;
task.Volume = preAspVol;
' />
					<Parameters >
