...
<Velocity11 file='Protocol_Data' md5sum='769199a36d43978c937bf3f478044c68' version='2.0' >
...
' />
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='35' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddAdapter3Mix' />
					</Parameters>
				</Task>
...
' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddLigationMix' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddLigationMix' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					<Enable_Backup >0</Enable_Backup>
...
' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='ligation' />
						<Parameter Category='' Name='Spawn as subroutine' Value='1' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddStopSolution' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddStopSolution' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='2785' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Prepare 5&apos; adapter mix!' />
						<Parameter Category='' Name='Body' Value='Add 1.1 x N uL of 5&apos; adapter into a 200 uL PCR tube.

Denaturate the adapter on a pre-heated thermal cycler in 70 degress Celcius for 2 minutes, then place immediately on ice.

Add 1.1 x N uL 10mM ATP to the tube. Pipette 6-8 times.

Add 1.1 x N uL T4 Ligase to the tube. Pipette 6-8 times.
------------------

Aliquot 3 x N + 6 uL to each well of column 4 in the MasterMix plate, where N is the number of columns with samples.
...
When finished click Continue' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddAdapter5Mix' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddAdapter5Mix' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
					<Enable_Backup >0</Enable_Backup>
...
' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='UsedTips1' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='NewTips4' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
						<Parameter Category='' Name='Spawn parameter' Value='' />
					</Parameters>
				</Task>
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='NewTips4' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
task.skip();
				...
				<Task Name='BuiltIn::CentrifugeAuto' >
					...
					<CustomData >
						<Parameter Name='Spin task id' Value='801664349l' />
...
task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Block Type' Value='96' />
						<Parameter Category='' Name='Program' Value='4,2,srna-li ' />
						<Parameter Category='Task Description' Name='Task number' Value='2' />
						<Parameter Category='Task Description' Name='Task description' Value='Run a program (Biometra TRobot)' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
					</Parameters>
				...
				<Task Name='BuiltIn::CentrifugeAuto' >
					...
					<CustomData >
						<Parameter Name='Spin task id' Value='871704149l' />
						<Parameter Name='Spin task Type' Value='1' />
					</CustomData>
				</Task>
				<Task Name='Nexus XPeel::Peel' >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='ligation' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='AddAdapter3Mix' >
				<Minimized >0</Minimized>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=numberOfColumns' Value='1' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = preAspVol;
task.Distancefromwellbottom = preAspDist;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1, dispColumn]];
task.Distancefromwellbottom = dispDist;
task.Volume = aspVolume;' />
					<Parameters >
...
task.Distancefromwellbottom = blowOutDist;
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1, tipColumn]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='UsedTips1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='AddAdapter5Mix' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='NewTips4' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;8d004d0b695f93c5700523356cd877df&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = aspVolume;
task.Distancefromwellbottom = aspDist;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MasterMixPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='AddLigationMix' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='6' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='32' />
						<Parameter Category='' Name='Wait' Value='' />
						<Parameter Category='' Name='Temperature Tolerance' Value='' />
						<Parameter Category='' Name='Timeout' Value='1' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
			...
			<Pipette_Process Name='AddStopSolution' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
task.skip();
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Location to use, plate' Value='SamplePlate2' />
						<Parameter Category='' Name='Location to use, location' Value='6' />
						<Parameter Category='' Name='Reservation time' Value='870' />
					</Parameters>
				</Task>
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					<Enable_Backup >0</Enable_Backup>
