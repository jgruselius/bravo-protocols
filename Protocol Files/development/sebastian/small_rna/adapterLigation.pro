...
<Velocity11 file='Protocol_Data' md5sum='10fdb43f41096c328fa993373a9ab70b' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddAdapter3Mix' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Take the plate from position 6, seal it, then put it on the thermal cycler and incubate at 70 deg for 2 minutes.
...
Immediately spin it down, remove the seal, replace it on position 6 and click Continue.' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Ligate 3&apos; Adapter' />
						<Parameter Category='' Name='Body' Value='Take the plate from position 6, seal it, then put it on a thermal cycler (with heated lid) and incubate at 28 deg for 1 hour.

After incubation, immediately spin it down, remove the seal, replace it on position 6 and click Continue.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Add the RNA 5&apos; Adapter mix to column 4' />
						<Parameter Category='' Name='Body' Value='Denaturate the RNA 5&apos; Adapter in a separate tube at 70 deg for 2 min, immediately put on ice, then add ATP and T4 RNA Ligase.

Add the RNA 5&apos; Adapter Mix to column 4 on the reagent plate on position 9.
...
Then, click Continue.' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Ligate 5&apos; Adapter' />
						<Parameter Category='' Name='Body' Value='Take the plate from position 6, seal it, then put it on a thermal cycler (with heated lid) and incubate at 28 deg for 1 hour.

After incubation, immediately spin the plate down, remove the seal, put it back on position 6 and click Continue.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
