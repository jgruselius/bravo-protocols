...
<Velocity11 file='Protocol_Data' md5sum='19f728b609d456fe3354e2070e6e95e6' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='p2' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='p1' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<Parameter >
						...
						<AssignedLocations_Node >
							<LocationInfo Value='Agilent Labware MiniHub - 1, cassette 1; slot 1, slot 2, slot 5' />
						</AssignedLocations_Node>
					</Parameter>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='sub3' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='sub3' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='p3' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='p2' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<Parameter >
						<RemoveFromGroups Name='RemoveFromGroups' Value='0' />
						<AssignedLocations_Node >
							<LocationInfo Value='Agilent Labware MiniHub - 1, cassette 2; slot 1, slot 2, slot 5' />
						</AssignedLocations_Node>
					</Parameter>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='sub4' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='sub4' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Load' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='p4' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='p3' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Unload' >
					...
					<Parameter >
						<RemoveFromGroups Name='RemoveFromGroups' Value='0' />
						<AssignedLocations_Node >
							<LocationInfo Value='Agilent Labware MiniHub - 1, cassette 3; slot 1, slot 2, slot 5' />
						</AssignedLocations_Node>
					</Parameter>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='sub5' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='sub5' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Load' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='p5' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='p4' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='sub2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='sub2' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Upstack' >
					<Devices >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='p5' />
			...
			<Pipette_Process Name='sub1' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p1' />
						<Parameter Category='' Name='Location to use, location' Value='1' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p1' />
						<Parameter Category='' Name='Location to use, location' Value='9' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='p1' />
			...
			<Pipette_Process Name='sub2' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p5' />
						<Parameter Category='' Name='Location to use, location' Value='1' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='p5' />
						<Parameter Category='' Name='Spawn control' Value='Precalculate # of plates (normal operation)' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='sub3' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p2' />
						<Parameter Category='' Name='Location to use, location' Value='1' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='p2' />
						<Parameter Category='' Name='Spawn control' Value='Precalculate # of plates (normal operation)' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='sub4' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p3' />
						<Parameter Category='' Name='Location to use, location' Value='1' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='p3' />
						<Parameter Category='' Name='Spawn control' Value='Precalculate # of plates (normal operation)' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='sub5' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='p4' />
						<Parameter Category='' Name='Location to use, location' Value='1' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='p4' />
						<Parameter Category='' Name='Spawn control' Value='Precalculate # of plates (normal operation)' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
