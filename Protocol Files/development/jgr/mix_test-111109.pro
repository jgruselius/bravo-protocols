...
<Velocity11 file='Protocol_Data' md5sum='eae0c3dcd191edd285273a9e1dba119c' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='sub1' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='sub1' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='process1' />
			...
			<Pipette_Process Name='sub1' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = &quot;1,2,1,12&quot;;
...
task.Liquidclass = &quot;j_normal_large_vol&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='process1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
