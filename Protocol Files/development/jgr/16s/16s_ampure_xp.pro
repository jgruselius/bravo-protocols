...
<Velocity11 file='Protocol_Data' md5sum='2d9d2a2ab91dce32f6cddc5dc4bf5d87' version='2.0' >
...
//for(var i in global.settings) { print(global.settings[i]); }' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(altBindPlate) {
	plate.labware = &quot;96 Eppendorf Twin.tec PCR&quot;;
}' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
...
var mPreAspVolume = PRE_ASP;
var mTransferVolume = elutionVolume;
var mAspDistance = altBindPlate ? 0.5 : 0.3;
...
var mGetTips = true;
var mReturnTips = true;
var mLiquidClass = altBindPlate ? &quot;j_slow_small_vol&quot; : &quot;j_slow_medium_vol&quot;;
var mPreAspVolume = PRE_ASP_LARGE;
var mTransferVolume = sampleVolume + beadVolume + 10 * !altBindPlate;
var mAspDistance = altBindPlate ? 0.5 : 0.75;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mWellSelection;
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = &quot;j_normal_medium_vol&quot;;
task.Distancefromwellbottom = mDispDistance;
task.Performtiptouch = true;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferSample' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.skip(); // By this time it has been standing here long enough
...
task.Tiptouchretractdistance = altBindPlate ? -5 : -14;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BindPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='1' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6d9e778ac7f7235a77c7705582d38a22&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
if(altBindPlate) {
	task.Dynamictipextension = dph(washVolume + 10, 0.75);
}
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BindPlate' />
