...
<Velocity11 file='Protocol_Data' md5sum='eec94f37675845891984349e21f74484' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet_red4.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open( &apos;C:/VWorks Workspace/Protocol Files/development/jgr/some_java.js&apos;);
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var fpath = &quot;C:\\VWorks Workspace\\Protocol Files\\development\\jgr\\ca_settings.cfg&quot;;
try {
    set = [&quot;beadVolume=60&quot;,&quot;washVolume=300&quot;];
    saveSettings(set, fpath);
} catch(e) {
    print(e);
}
var settings;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='1' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='1' />
					</Parameters>
				</Task>
				<Plate_Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Numberoftimestoloop = 1;' />
					<Parameters >
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='test_post-delay' />
