...
<Velocity11 file='Protocol_Data' md5sum='c88ce3f2f8994e4dcaa797418cd5e38f' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='1' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='Plate filler for TruSeq RNA Access library prep' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var volumes = global.settings.volumes;' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Fill' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Fill' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='EthanolReservoir' />
			...
			<Pipette_Process Name='Fill' >
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=volumes.length' Value='2' />
...
task.Location_plate = (i===0) ? &quot;ElutionBufferReservoir&quot; : &quot;EthanolReservoir&quot;;
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='EthanolReservoir' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Location_plate = (i===0) ? &quot;ElutionBufferReservoir&quot; : &quot;EthanolReservoir&quot;;
task.Wellselection = mWellSelection;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Location_plate = (i===0) ? &quot;ElutionBufferPlate&quot; : &quot;EthanolPlate&quot;;
task.Wellselection = mWellSelection;
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
...
task.Location_plate = (i===0) ? &quot;ElutionBufferPlate&quot; : &quot;EthanolPlate&quot;;
task.Wellselection = mWellSelection;
task.Volume = mPreAspVolume;
