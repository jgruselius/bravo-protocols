...
<Velocity11 file='Protocol_Data' md5sum='8a5343c2742c3f86a1ccfbe94016456a' version='2.0' >
...
var beadDiluteVolume1 = global.settings.beadDiluteVolume1 || 32.5;
var beadDiluteVolume2 = global.settings.beadDiluteVolume2 || 2.5;
var sampleVolume = global.settings.sampleVolume || 100;
var bindVolume1 = sampleVolume + beadDiluteVolume1 + beadVolume1;
var transferVolume = global.settings.transferVolume || 250;
var bindVolume2 = transferVolume + beadDiluteVolume2 + beadVolume2;
var washVolume = 200;
var washes = 2;
...
var pelletTime = testMode ? 1 : 180;
var pelletTimeShort = testMode ? 1 : 30;
var pelletTimeLong = testMode ? 1 : 240;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='addDiluent1' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='addDiluent1' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='transferBeads1' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='addDiluent2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='addDiluent2' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='transferBeads2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='transferBeads2' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='BindPlate2' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='BindPlate2' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='BindPlate1' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='addDiluent1' >
				<Minimized >0</Minimized>
...
var mTransferVolume = beadDiluteVolume1;
var mAspDistance = 1;
var mDispDistance = 2;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if(mGetTips &amp;&amp; mTransferVolume &gt; 0) {
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(mPreAspVolume === 0 || mTransferVolume === 0) {
   task.skip();
}
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(mTransferVolume === 0) task.skip();
task.Wellselection = mWellSelection;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if((mPreAspVolume === 0 &amp;&amp; !mDoTipTouch) || mTransferVolume === 0) {
   task.skip();
}
task.Wellselection = mWellSelection;
task.Volume = mPreAspVolume;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='if(mReturnTips &amp;&amp; mTransferVolume &gt; 0) {
   task.Wellselection = mTipSelection;
} else {
   task.skip();
}' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='addDiluent2' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var mLiquidClass = &quot;j_normal_large_vol&quot;;
var mPreAspVolume = PRE_ASP;
var mTransferVolume = beadDiluteVolume2;
var mAspDistance = 1;
var mDispDistance = 2;
var mBlowoutHeight = 5;
var mDoTipTouch = true;
...
var mPreAspVolume = PRE_ASP_LARGE;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='213' />
					</Advanced_Settings>
...
var mLiquidClassMix = &quot;j_normal_mixing&quot;;
var mPreAspVolume = PRE_ASP_LARGE;
...
var mTimer = new Date().getTime();
task.Volume = mMixVolume;
task.Liquidclass = mLiquidClassMix;
task.Mixcycles = mTimerCycles;
task.Aspiratedistance = mAspDistance;
if(mAspDistance !== mDispDistance) {
    task.Dispenseatdifferentdistance = true;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='BindPlate2' />
...
var mPreAspVolume = PRE_ASP_LARGE;
var mTransferVolume = bindVolume2 + 10;
...
var mTransferVolume = MAX_VOLUME / 2;
var mAspDistance = 1;
var mDispDistance = 30;
var mDoTipTouch = true;
var mTouchRetract = 5;' />
...
task.Preaspiratevolume = mPreAspVolume;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ElutionBufferPlate' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = mDispDistance;
task.Liquidclass = mLiquidClass;
if(mDoTipTouch) {
    task.Performtiptouch = true;
    task.Tiptouchretractdistance = mTouchRetract;
...
var mLiquidClass = &quot;j_normal_medium_vol&quot;;
var mPreAspVolume = 10;
var mTransferVolume = MAX_VOLUME;
var mAspDistance = 1;
var mDispDistance = 30;
var mDoTipTouch = true;
var mTouchRetract = 5;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBeads1' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var mAspDistance = 1;
var mDispDistance = 1;
var mMixVolume = (0.8 * beadVolume1 &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * beadVolume1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mMixVolume = (0.8 * (beadVolume1+beadDiluteVolume1) &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * (beadVolume1+beadDiluteVolume1);
var mMixLiquidClass = &quot;j_normal_mixing&quot;;
var mMixCycles = 10;
var mMixAspDistance = 1;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBeads2' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var mAspDistance = 1;
var mDispDistance = 1;
var mMixVolume = (0.8 * beadVolume2 &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * beadVolume2;
var mMixLiquidClass = &quot;j_normal_mixing&quot;;
var mMixCycles = 5;
var mMixAspDistance = 1;
var mMixDispDistance = 5;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferBindMix' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Reserve Location' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					...
					<TaskScript Name='TaskScript' Value='task.Reservationtime = pelletTimeLong;' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='BindPlate1' />
						<Parameter Category='' Name='Location to use, location' Value='7' />
						<Parameter Category='' Name='Reservation time' Value='0' />
					</Parameters>
				</Task>
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='transferSample' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.skip(); // By this time it has been standing long enough..
task.Reservationtime = pelletTime;' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='SamplePlate' />
						<Parameter Category='' Name='Location to use, location' Value='7' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var bindMixVolume = 0.6 * (bindVolume1 + sampleVolume);
bindMixVolume = (bindMixVolume &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : bindMixVolume;' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
