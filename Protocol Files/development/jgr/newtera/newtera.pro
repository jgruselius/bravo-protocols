...
<Velocity11 file='Protocol_Data' md5sum='0cc284affa589b7df949fa3755262112' version='2.0' >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Downstack' >
					...
					<TaskScript Name='TaskScript' Value='if(!beadVolume) task.skip();' />
					<Parameters >
...
var deadVolume = +(columns &gt; 1) * 15;		// Extra liquid volume to aspirate
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;f7cd2435b3a9f2941c99020c5f9ff00d&apos; version=&apos;1.0&apos; &gt;
...
if(0.7 * volumeLeft &gt; 0.9 * MAX_TIP_VOLUME) {
	task.Volume = 0.9 * MAX_TIP_VOLUME;
} else {
	task.Volume = 0.7 * volumeLeft;
}' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,reagentColumn]];
if(columns &lt; 5) {
  task.Dynamictipextension = dph(tipVolume, 0.4);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,reagentColumn]];
task.Distancefromwellbottom = (columns &lt; 5) ? 8 : 15;
if(columns == columnsDone) {
	task.Performtiptouch = true;
	task.Whichsidestousefortiptouch = &quot;None&quot;;
	task.Tiptouchretractdistance = (columns &lt; 5) ? -7 : -14.5;
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.Distancefromwellbottom = (columns &lt; 5) ? 0.6 : 0.4;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=tipVolume;' Value='10' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='tagmentation' >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='1377' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = sampleVolume +beadVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TagmentationPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(shakeMix) task.skip();
task.Volume = 0.8 * (sampleVolume + reagentVolume + beadVolume);
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TagmentationPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(shakeMix) task.skip();
task.Volume = 0.7 * (sampleVolume + reagentVolume + beadVolume);
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TagmentationPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						...
						<Parameter Category='Properties' Name='Mix cycles' Value='10' />
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='0.85' />
						<Parameter Category='Distance From Well Bottom' Name='Dispense at different distance' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(shakeMix) task.skip();
task.Volume = 0.8 * (sampleVolume + reagentVolume + beadVolume + stopVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Transfer plate' />
						<Parameter Category='' Name='Body' Value='Transfer the plate in position 5 to a thermal cycler and run the denaturation program. Click &apos;Continue&apos; when the program HAS STARTED to prepare for the next step.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
