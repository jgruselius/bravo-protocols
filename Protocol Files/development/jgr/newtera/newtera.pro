...
<Velocity11 file='Protocol_Data' md5sum='2983e6e689a7ca31e50e16f70f59df88' version='2.0' >
...
var aliquotVolume = beadVolume;	// Volume to dispense per well
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if(!beadVolume) task.skip();
task.Wellselection = [[1,++tipColumn]];' />
					<Parameters >
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(!beadVolume) task.skip();
task.Wellselection = [[1,reagentColumn+2]];
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(!beadVolume) task.skip();
task.Wellselection = [[1,++columnsDone]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='if(!beadVolume) task.skip();
task.Wellselection = [[1,13-tipColumn]];' />
					<Parameters >
