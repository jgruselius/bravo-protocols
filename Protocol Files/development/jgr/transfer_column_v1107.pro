...
<Velocity11 file='Protocol_Data' md5sum='ae3154c06ee225d309412f1ec58a6f3f' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var col_source = 3;
var num_cols = 6;
var vol_transfer = 60;
var vol_pre_asp = 10;
var head_mode = &quot;1,2,1,1&quot;;
var vol_max = 170;
var n_steps;
var vol_step;' />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,12]];' />
					<Parameters >
...
task.Wellselection = [[1,col_source]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=num_cols;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables >
						<Variable fIncrement='1' iFreqValue='0' strFrequency='Every time' strInitialValue='1' strVariableName='col_current' />
					</Variables>
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
...
n_steps =Math.ceil((vol_transfer + vol_pre_asp) / vol_max);
vol_step = vol_transfer / n_steps;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.numberOfRuns = n_steps;' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=n_steps;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = vol_step;
task.Wellselection = [[1,0+col_current]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,col_source]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SourcePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
