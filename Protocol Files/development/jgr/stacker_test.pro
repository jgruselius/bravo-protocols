...
<Velocity11 file='Protocol_Data' md5sum='6ba23f04ee8b441ef6eb51a66ad18579' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='subProcess1' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='subProcess1' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Reorder' >
					<Devices >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate storage time' Value='0' />
						<Parameter Category='' Name='Number of plates to store' Value='8' />
						<Parameter Category='' Name='Assume stacks are empty' Value='0' />
					</Parameters>
				</Task>
				...
				<Plate_Parameters >
					...
					<Parameter Name='Simultaneous plates' Value='8' />
			...
			<Pipette_Process Name='subProcess1' >
				<Minimized >0</Minimized>
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='plate1' />
