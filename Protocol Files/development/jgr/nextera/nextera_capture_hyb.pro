...
<Velocity11 file='Protocol_Data' md5sum='b38f88941cd3c17d8166b9a631525918' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='1' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\SureSelect\XT_Illumina\BravoMiniPHBenchCel_round_magnet.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var hybStep = global.capture.hybMode || 1;' />
					<Parameters >
		...
		<Main_Processes >
			...
			<Pipette_Process Name='addBuffer' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = (hybStep == 1) ? 50 : 65;	// Volume to dispense per well
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = (columns &lt; 4) ? 0.65 : 0.5;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='addOligos' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = 10;	// Volume to dispense per well
var MAX_TIP_VOLUME = 175;	// Tip capacity
var columnsDone = 0;	// Number of columns dispensed so far
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Distancefromwellbottom = (columns &lt; 4) ? 0.4 : 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=tipVolume;' Value='10' />
...
var mTransferVolume = (hybStep == 1) ? 40 : 23;
