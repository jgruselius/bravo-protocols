...
<Velocity11 file='Protocol_Data' md5sum='a34286504f22fe145319fd658c39db69' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var MAX_TIP_VOLUME = 175;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='addOligos' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='dilutionBufferPlate' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='addOligos' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(columns &lt; 4) plate.labware = &quot;96 Eppendorf Twin.tec PCR&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
...
task.Distancefromwellbottom = (columns &lt; 4) ? 0.65 : 0.5;' />
					<Parameters >
...
if(columns == columnsDone) {
	...
	task.Distancefromwellbottom = (columns &lt; 4) ? 5 : 15;
	task.Tiptouchretractdistance = (columns &lt; 4) ? -4.5 : -14.5;
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='addOligos' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = oligoVolume;	// Volume to dispense per well
var columnsDone = 0;	// Number of columns dispensed so far
...
task.Distancefromwellbottom = (columns &lt; 4) ? 0.4 : 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=tipVolume;' Value='10' />
...
var mDispDistance = 4;
var mMixVolume = 0.8 * (sampleVolume + bufferVolume + oligoVolume + dilutionVolume);
var mMixLiquidClass = &quot;j_normal_mixing&quot;;
var mMixCycles = 6;
var mMixAspDistance = 1.8;
var mMixDispDistance = 4.8;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if(columns &gt; 10) task.Location_plate = &quot;sampleTips&quot;;
if(mGetTips) {
...
if(dilutionVolume) task.Location_plate = &quot;dilutionBufferPlate&quot;;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
   ...
   task.Volume = dilutionVolume;
} else {
   task.skip();
}
' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='dilutionBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mWellSelection;
task.Volume = mTransferVolume + dilutionVolume;
task.Liquidclass = mLiquidClass;
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove the plate from postion 5, seal and transfer to a thermal cycler and run the hybridization program. Confirm this message to finish the protocol.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
