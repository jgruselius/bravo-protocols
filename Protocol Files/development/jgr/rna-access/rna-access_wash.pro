...
<Velocity11 file='Protocol_Data' md5sum='d42f7574e10b21008673daee6aed40d4' version='2.0' >
...
var beadVolume = global.beadVolume;
var washVolume = global.washVolume;
var dph = global.dph;

// Testing:
var testMode = global.formTestMode;' />
				</Task>
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' Value='22' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='52' />
						<Parameter Category='' Name='Wait' Value='' />
						<Parameter Category='' Name='Temperature Tolerance' Value='1' />
						<Parameter Category='' Name='Timeout' Value='15' />
						<Parameter Category='' Name='Allow concurrent operation' Value='1' />
					</Parameters>
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='present1' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='present1' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='present2' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='adapter' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Transfer the plate from the thermal cycler to position 8 of the Bravo deck an select &apos;Continue&apos;.' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mWellSelection;
if(mMixVolume &gt; maxVolume * 0.8) {
	mMixVolume = 0.8 * maxVolume;
}
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='captureMix' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mixVolume = MAX_TIP_VOLUME;
var mHeadMode = headMode;
var mWellSelection = [[1,1]];
var mTipSelection = [[1,13-columns]];
var mGetTips = true;
...
var mIncubationTime = testMode ? 60 : 25 * 60;
var mTimerCycles = 5;
var mMixVolume = 0.8*(sampleVolume+beadVolume);
var mAspDistance = 3;
var mDispDistance = 3;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='140' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='task.Wellselection = mWellSelection;
if(mMixVolume &gt; maxVolume * 0.8) {
	mMixVolume = 0.8 * maxVolume;
...
task.Volume = mMixVolume;
// Time 5 mix cycles to calculate how
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='1320' />
					</Advanced_Settings>
...
var mPreAspVolume = 30;
var mTransferVolume = sampleVolume + beadVolume + 30;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='present1' >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Transfer plate' />
						<Parameter Category='' Name='Body' Value='Seal the Nunc plate in position 8 and mount it on the pre-heated adapter on positon 6 then choose &apos;Continue&apos;. The incubation will take 25 minutes then you will be asked to return the plate.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(testMode) task.Reservationtime = 30;' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='capturePlate' />
						<Parameter Category='' Name='Location to use, location' Value='8' />
						<Parameter Category='' Name='Reservation time' Value='1500' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::User Message' >
					<Enable_Backup >0</Enable_Backup>
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Move the Nunc plate from the adapter on position 6 to position 8 and unseal, then choose &apos;Continue&apos;.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
			...
			<Pipette_Process Name='present2' >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='144' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Transfer plate' />
...
var mPreAspVolume = 10;
var mTransferVolume = washVolume;
var mAspDistance = 1.5;
var mDispDistance = 2;
var mMixVolume = 0.75 * washVolume;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(mMixVolume &gt; 0.8 * maxVolume) {
