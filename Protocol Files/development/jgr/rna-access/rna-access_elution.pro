...
<Velocity11 file='Protocol_Data' md5sum='0e0bd4ea4b231974c91e268351ecb9e5' version='2.0' >
...
var elutionMixes = 20;
var buffer1Volume = global.settings.buffer1Volume;
var buffer2Volume = global.settings.buffer2Volume;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='aliquotBuffer1' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='aliquotBuffer1' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='aliquotBuffer2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='96 Deep Well PP Sqr Well V Btm' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='aliquotBuffer2' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='transferTips' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='transferTips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='// This is the plate with beads from the washing step' />
					<Parameters >
						<Parameter Category='' Name='Device to use' Value='Bravo - 1' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='mixPlate' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='signalPlateCleared' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='elutionPlate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='signalPlateCleared' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='mixPlate' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='aliquotBuffer1' >
				<Minimized >0</Minimized>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = buffer1Volume;	// Volume to dispense per well
...
task.Distancefromwellbottom = (columns &lt; 7) ? 0.5 : 0.3;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='mixPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
if(columns == columnsDone) {
	...
	task.Distancefromwellbottom = (columns &lt; 7) ? 5 : 15;
	task.Tiptouchretractdistance = (columns &lt; 7) ? -4.5 : -14.5;
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='aliquotBuffer2' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = buffer2Volume;	// Volume to dispense per well
var columnsDone = 0;	// Number of columns dispensed so far
var deadVolume = 3;		// Extra liquid volume to aspirate
...
task.Distancefromwellbottom = (columns &lt; 7) ? 0.4 : 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=tipVolume;' Value='10' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,++columnsDone]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='elutionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=aliquotVolume;' Value='10' />
						<Parameter Category='Volume' Name='Blowout volume' Value='0' />
...
var mTransferVolume = buffer1Volume;
var mAspDistance = 0.3;
var mDispDistance = 2;
var mMixVolume = 0.8 * buffer1Volume;
var mMixLiquidClass = &quot;j_normal_mixing&quot;;
var mMixCycles = elutionMixes;
var mMixAspDistance = 0.7;
var mMixDispDistance = 0.7;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Reservationtime = (testMode) ? 1 : 2 * 60;' />
					<Parameters >
...
var mMixVolume = 0.75*(buffer1Volume+buffer2Volume);
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='transferTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;b37e670787c8474f935b41a6ceb5f9f6&apos; version=&apos;1.0&apos; &gt;
