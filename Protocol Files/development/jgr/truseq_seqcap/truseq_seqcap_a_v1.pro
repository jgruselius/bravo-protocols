...
<Velocity11 file='Protocol_Data' md5sum='c4d1ff155ffa9a65c63f2c7ffa2d97c8' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var numberColumns = 1;
...
var washStep = 2;' />
		...
		<Main_Processes >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='waterReservoir' />
...
var mPreAspVolume = 10;
var mTransferVolume = (washStep == 1) ? 40 : 30;
...
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;
task.Location_plate = (washStep == 1) ? &quot;sourcePlate&quot; : &quot;waterReservoir&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='waterReservoir' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(washStep == 1) {
	task.skip();
} else {
	task.Wellselection = mWellSelection;
	task.Volume = 10;
	task.Postaspiratevolume = 5;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mWellSelection;
task.Volume = (washStep == 2) ? (mTransferVolume + 15) : mTransferVolume;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='reactionPlate' />
