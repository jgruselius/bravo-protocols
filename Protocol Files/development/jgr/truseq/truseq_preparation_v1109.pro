...
<Velocity11 file='Protocol_Data' md5sum='29a2d71a4d6dad2d7c47c76744d3ea0e' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\SureSelect\XT_Illumina\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var hasTips = false;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='function getTips() {
   var newTips = !hasTips;
   hasTips = true;
   return newTips;
}
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='FragSepA' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
...
var mGetTips = getTips();
var mTipColumn = 12;
var mReturnTips = returnTips();
...
var mLiquidClass = &quot;j_normal_large_vol&quot;;
var mPreAspVolume = 20;
var mTransferVolume = beadResuspVolume * 2;
var mAspDistance = 1;
var mDispDistance = 2;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='TransferWashBuffer' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var maxVolume = 170;
var mHeadMode = headMode;
var mWellSelection = [[1,1]];
var mTipSelection = [[1,13-numberColumns]];
var mGetTips = getTips();
