		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Enable this task to test the protocol outside a runset
var global = GetGlobalObject();
global.ca = {};
global.ca.columnsOfSamples = 12;
global.ca.sampleVolume = 50;
global.ca.beadVolume = 30;
global.ca.precipVolume = 100;
global.ca.beadResuspVolume = 10;
global.ca.bindTime = 10;
global.ca.elutionVolume = 25;' />
				</Task>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
...
var columnsOfSamples, sampleVolume, beadVolume, 
	   precipVolume, beadResuspVolume, bindTime, 
	   elutionVolume;
try {
	columnsOfSamples = global.ca.columnsOfSamples;
	sampleVolume = global.ca.sampleVolume;
	beadVolume = global.ca.beadVolume;
	precipVolume = global.ca.precipVolume;
	beadResuspVolume = global.ca.beadResuspVolume;
	bindTime = global.ca.bindTime;
	elutionVolume = global.ca.elutionVolume;
} catch(e) {
	print(&quot;WARNING: Parameters could not be set, global values not defined properly.&quot;);
	print(&quot;(&quot; + e + &quot;)&quot;);
}
