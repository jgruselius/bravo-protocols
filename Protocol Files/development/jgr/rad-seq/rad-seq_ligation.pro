...
<Velocity11 file='Protocol_Data' md5sum='f780d4e5339661f0e8da2e8e03316bc7' version='2.0' >
...
var reagentVolume = global.settings.reagentVolume;
var bufferVolume = global.settings.bufferVolume;
var adapterVolume = global.settings.adapterVolume;
var incubationTemperature = global.settings.incubationTemperature || tempRt;
...
' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Temperature' TaskParameterScript='=tempRt;' Value='' />
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='SAMPLE_PLATE' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(doOffDeckIncubation) task.skip();' />
					<Parameters >
				...
				<Task Name='BuiltIn::Incubate' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(doOffDeckIncubation) task.skip();
task.Incubationtime = incubationTime;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='0' />
						<Parameter Category='Task Description' Name='Task description' Value='' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='322' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='if(!doOffDeckIncubation) task.skip();

task.Body = &quot;Take the Eppendorf plate from &quot; +
	&quot;position 5 of the Bravo deck, seal, place in a thermal &quot; +
	&quot;cycler and run the &quot; + protocolName.toLowerCase() +
	&quot; program. Once the incubation has finished, return the &quot; +
	&quot;plate to position 5 and choose &apos;Continue&apos;.&quot;;' />
					<Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(columns &lt; 7) plate.labware = &quot;96 Eppendorf Twin.tec PCR&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Place Plate' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AliquotAdapter' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='FINAL_PLATE' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
					<Has_Breakpoint >0</Has_Breakpoint>
			...
			<Pipette_Process Name='AliquotAdapter' >
				<Minimized >0</Minimized>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = adapterVolume;	// Volume to dispense per well
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,tipColumn+1]];' />
					<Parameters >
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,reagentColumn+1]];
if(columns &lt; 7) task.Distancefromwellbottom = 0.5;' />
					<Parameters >
...
if(columns == columnsDone) {
	...
	task.Tiptouchretractdistance = (columns &lt; 7) ? -7 : -14.5;
}' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,13-tipColumn-1]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,tipColumn+2]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,reagentColumn+2]];
if(columns &lt; 7) task.Distancefromwellbottom = 0.5;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,13-tipColumn-2]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='UsedTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='AliquotMix' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,reagentColumn]];
if(columns &lt; 7) task.Distancefromwellbottom = 0.5;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReagentPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.skip();' />
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Task description' Value='' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Location to use, plate' Value='ReactionPlate' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = tempRt;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=tempRt;' Value='' />
...
*/
if(doOffDeckIncubation) task.skip();
task.Temperature = 58;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='if(doOffDeckIncubation) task.skip();
task.Temperature = incubationTemperature;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=incubationTemperature;' Value='' />
						<Parameter Category='' Name='Wait' Value='1' />
						<Parameter Category='' Name='Temperature Tolerance' Value='1' />
						<Parameter Category='' Name='Timeout' Value='10' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = sampleVolume + adapterVolume + reagentVolume;
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(sampleVolume + adapterVolume + reagentVolume, 0.5);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ReactionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.7 * (sampleVolume + adapterVolume + reagentVolume + bufferVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.8 * (sampleVolume + adapterVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = sampleVolume + adapterVolume;
task.Distancefromwellbottom = 0.5;
task.Dynamictipextension = global.dph(sampleVolume + adapterVolume, 0.5);' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TransferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.8 * (sampleVolume + reagentVolume + adapterVolume);
if(mix_vol &gt; MAX_MIX_VOLUME) {
	mix_vol = MAX_MIX_VOLUME;
}
task.Volume = mix_vol;' />
