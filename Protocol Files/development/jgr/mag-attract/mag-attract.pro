...
<Velocity11 file='Protocol_Data' md5sum='05e4ff0aea38dad67120785f17e7f984' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Buffer2' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Beads' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Buffer3' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Buffer1' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Buffer2' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Buffer4' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Buffer3' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Buffer5' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Buffer4' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Buffer5' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='BUFFER2_READY' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='WideTips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='WideTips' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,m.tipColumn]];' />
					<Parameters >
...
task.Volume = m.preAspVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Beads' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='1.2' />
...
&lt;/Velocity11&gt;' />
   ...
   task.Wellselection = [[1,13-m.tipColumn--]];
} else {
   task.skip();
}' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
   ...
   task.Wellselection = m.tipSelection;
} else {
   task.skip();
}' />
					<Parameters >
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Buffer1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
	...
	headMode: &quot;1,2,1,&quot;+settings.columns,
	wellSelection: [[1,1]],
	tipSelection: [[1,13-settings.columns]],
	getTips: true,
	returnTips: true,
	liquidClass: &quot;j_normal_large_vol&quot;,
	preAspVolume: 5,
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WideTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Buffer5' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
			...
			<Pipette_Process Name='elution' >
				...
				<Task Name='Bravo::secondary::Shake' Task_Type='1024' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Time for operation in Timed mode' TaskParameterScript='=settings.shakeTime' Value='180' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = m.wellSelection;
task.Volume = m.transferVolume / m.numberSteps;
task.Liquidclass = &quot;j_normal_large_volume&quot;;
task.Distancefromwellbottom = m.dispDistance;
task.Performtiptouch = m.doTipTouch;
if(m.doTipTouch) {
   task.Tiptouchretractdistance = m.touchRetract;
...
&lt;/Velocity11&gt;' />
	...
	liquidClass: &quot;j_normal_large_vol&quot;,
	preAspVolume: 5,
	transferVolume: (i &lt; 2) ? volume.buffer2 : volume.buffer3,
	aspDistance: 1,
	dispDistance: 2,
	blowoutHeight: 5,
	doTipTouch: true,
...
task.Location_plate = (i &lt; 2) ? &quot;Buffer2&quot; : &quot;Buffer3&quot;;
task.Wellselection = m.wellSelection;
task.Volume = m.preAspVolume;
task.Liquidclass = &quot;j_normal_large_vol&quot;;
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Buffer2' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Location_plate = (i &lt; 2) ? &quot;Buffer2&quot; : &quot;Buffer3&quot;;
task.Wellselection = m.wellSelection;
task.Volume = m.transferVolume / m.numberSteps;
task.Liquidclass = m.liquidClass;
task.Distancefromwellbottom = m.aspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Buffer3' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Buffer4' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
	...
	liquidClass: &quot;j_slow_large_vol&quot;,
	preAspVolume: 10,
	transferVolume: volume.buffer4 + 10,
	aspDistance: 0.6,
	dispDistance: 30,
	blowoutHeight: 30,
	doTipTouch: true,
