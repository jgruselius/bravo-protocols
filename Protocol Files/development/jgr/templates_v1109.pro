...
<Velocity11 file='Protocol_Data' md5sum='6cc7a69c9884b06e0d1ac794df1628b8' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Reservoir' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Reservoir' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Mix' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Mix' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Incubate' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Incubate' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Rinse' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Rinse' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Plate1' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Plate2' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Plate3' />
			...
			<Pipette_Process Name='Distribute' >
				<Minimized >0</Minimized>
				<Task DeviceType='Bravo' IsDerived='1' Name='User Defined Macro::distributeMacro' TaskCount='16' Type='4' Version='1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var maxVolume = 160;
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Plate1' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Plate2' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Incubate' >
				<Minimized >0</Minimized>
				<Task DeviceType='Bravo' IsDerived='1' Name='User Defined Macro::incubateMixMacro' TaskCount='13' Type='4' Version='1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
...
var mWellSelection = [[1,12]];
var mGetTips = true;
var mReturnTips = true;
var mLiquidClass = &quot;j_slow_mixing&quot;;
var mPreAspVolume = 10;
var mIncubationTime = 1 * 60;
var mMixInterval = 60;
var mMixVolume = 100;
var mMixCycles = 3;
var mAspDistance = 1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mNumberMixes = Math.floor(mIncubationTime / mMixInterval);
var mTimer;' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=mNumberMixes;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables />
				</Task>
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='mTimer = new Date().getTime();
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='mTimer = (mIncubationTime / mNumberMixes) - Math.floor((new Date().getTime() - mTimer) / 1000);;
task.Reservationtime = (mTimer &gt; 0) ? mTimer : 0;' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='Plate1' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Mix' >
				<Minimized >0</Minimized>
				<Task DeviceType='Bravo' IsDerived='1' Name='User Defined Macro::mixMacro' TaskCount='9' Type='4' Version='1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mHeadMode = &quot;1,2,1,6&quot;;
var mWellSelection = [[1,6]];
var mGetTips = false;
var mReturnTips = true;
var mLiquidClass = &quot;j_slow_mixing&quot;;
var mPreAspVolume = 10;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = mMixVolume;
task.Liquidclass = mLiquidClass;
task.Mixcycles = mMixCycles;
task.Aspiratedistance = mAspDistance;
if(mAspDistance !== mDispDistance) {
...
&lt;/Velocity11&gt;' />
    ...
    task.skip();
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Mark tips as used' Value='1' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;95ec35ec6d57ae52f9482c7e37c21e5b&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;6&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;5&apos; Row=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Reservoir' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::JavaScript' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var mMixCycles = 0;
var mMixAspDistance = 0;
var mMixDispDistance = 0;
var mBlowoutHeight = 5;
var mDoTipTouch = true;
var mTouchRetract = 5;' />
				</Task>
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Plate3' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(mDoMix) {
   var mTemp = mTransferVolume * 0.8;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Rinse' >
				<Minimized >0</Minimized>
				<Task DeviceType='Bravo' IsDerived='1' Name='User Defined Macro::tipRinseMacro' TaskCount='15' Type='4' Version='1' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
