...
<Velocity11 file='Protocol_Data' md5sum='26c947808689056cd19d5eb415a4bd3b' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var g = GetGlobalObject();
var rows = parseInt(g.formRows, 10);
var headMode = [2,1,rows,12].join(&quot;,&quot;);
var volume = {};
volume.dilution = parseFloat(g.formDilutionVolume);
volume.sample = parseFloat(g.formSampleVolume);
volume.marker = parseFloat(g.formMarkerVolume);
volume.analyte = parseFloat(g.formAnalyteVolume);
volume.total = volume.sample + volume.dilution;
var skipDilution = !volume.dilution || volume.dilution &lt; 0;
var skipMix = !!g.formSkipMix;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='DistributeMarker' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='DistributeMarker' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='TransferAnalyte' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='TransferAnalyte' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='FraggePlate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='///if(rows &lt; 8) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Replace tipbox' />
						<Parameter Category='' Name='Body' Value='Empty the tip box with marker tips.

If running 8 rows: Replace the tipbox in position 2 with a new tipbox containing 8 rows of clean tips.
...
Press &apos;Continue&apos; when done.' />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='SampleDilution' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='SampleDilution' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::User Message' >
					<Enable_Backup >0</Enable_Backup>
					...
					<TaskScript Name='TaskScript' Value='if(!skipMix) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Manual mix' />
						<Parameter Category='' Name='Body' Value='Remove the dilution plate from position 5, mix thouroughly and put back.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='MarkerTips' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='DilutionPlate' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='MarkerPlate' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='DilutionBuffer' />
			...
			<Pipette_Process Name='DistributeMarker' >
				<Minimized >0</Minimized>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var aliquotVolume = volume.marker;	// Volume to dispense per well
var rowsDone = 0;	// Number of rows dispensed so far
var deadVolume = 5;		// Extra liquid volume to aspirate

// Total volume to transfer:
var transferVolume = aliquotVolume * rows;
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6844ce726161931b5516fcc6833576d3&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;2&apos; TipType=&apos;0&apos; /&gt;
&lt;/Velocity11&gt;' />
					</Parameters>
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MarkerTips' />
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6081f39f2d2c487f6043a0d746c9f4d7&apos; version=&apos;1.0&apos; &gt;
...
var volumeLeft = (rows - rowsDone) * aliquotVolume;
...
var dispenseSteps = (tipVolume - deadVolume) / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MarkerPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;08a449e1ba02883513bc5226f60603bf&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[++rowsDone,1]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FraggePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(rows == rowsDone) {
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips Off' Task_Type='32' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;2207c4cea9ba7120a6ee1fac41ad333d&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;2&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;0&apos; Row=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='SampleDilution' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var maxVolume = MAX_TIP_VOLUME;
var mHeadMode = headMode;
var mWellSelection = [[1,1]];
var mTipSelection = (rows&gt;7) ? [[1,1]] : [[8-rows,1]];
var mGetTips = true;
var mReturnTips = true;
var mLiquidClass = &quot;j_normal_large_vol&quot;;
var mPreAspVolume = 10;
var mTransferVolume = volume.dilution;
var mAspDistance = 1;
var mDispDistance = 2;
var mMixVolume = (volume.total&gt;200) ? 160 : 0.8*volume.total;
...
var mTouchRetract = -4;
var oneStep = volume.total &lt; MAX_TIP_VOLUME; ' />
				</Task>
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if(skipDilution) task.skip();
if(rows &lt; 8) task.Wellselection = [[8-rows,1]];
if(mGetTips) {
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DilutionBuffer' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var mNumberSteps = skipDilution ? 0 : Math.ceil(mTransferVolume / maxVolume);' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(oneStep || skipDilution) task.skip();
task.Wellselection = mWellSelection;
task.Volume = mTransferVolume / mNumberSteps;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DilutionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(skipDilution) task.skip();
task.Wellselection = mWellSelection;
task.Volume = oneStep? volume.total : volume.sample;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DilutionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(skipDilution || skipMix) task.skip();
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(skipDilution) task.skip();
if(mPreAspVolume == 0 &amp;&amp; !mDoTipTouch) {
   task.skip();
}
task.Wellselection = mWellSelection;
task.Volume = mPreAspVolume;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='TransferAnalyte' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='// Exclude column 12 to leave room for ladder:
task.Headmode = [2,1,rows,12].join(&quot;,&quot;);' />
					<Parameters >
						<Parameter Category='' Name='Head mode' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;5929d18748dd2bd11633d3faafa655d1&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;0&apos; TipType=&apos;0&apos; /&gt;
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='if(rows &lt; 8) task.Wellselection = [[8-rows,1]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='MarkerTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(skipDilution) task.Location_plate = &quot;SamplePlate&quot;; ' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DilutionPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=volume.analyte' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=volume.analyte' Value='10' />
						<Parameter Category='Volume' Name='Blowout volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='j_normal_small_vol' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='2' />
						<Parameter Category='Properties' Name='Dynamic tip retraction' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(skipMix) task.skip();
task.Volume = 0.7 * (volume.analyte + volume.marker)' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FraggePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
