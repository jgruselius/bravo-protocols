...
<Velocity11 file='Protocol_Data' md5sum='7cec44f4c4d64d23fb594d61b4be51a4' version='2.0' >
...
// FOR TESTING:
var columnsOfSamples = 12;
var beadVolume = 20;
var beadResuspVolume = 10;

/* UNCOMMENT FOR RUNSET:
...
checkSettings();' />
		...
		<Main_Processes >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='SourceBeadPlate' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='WashedBeadPlate' />
			...
			<Pipette_Process Name='BeadDistribution' >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Volume to dispense per well:
var aliquotVolume = beadVolume;
// Tip capacity:
var maxTipVolume = 170;
 // Total number of columns to process:
var columns = columnsOfSamples;
// Number of columns dispensed so far:
var columnsDone = 0;

// Total volume to transfer:
var totalVolume = aliquotVolume * columns;
// Number of aspirations necessary:
var aspirateSteps = Math.ceil(totalVolume / maxTipVolume);
' />
				</Task>
...
var dispenseSteps = tipVolume / aliquotVolume;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SourceBeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WashedBeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.Volume = mixVolume;' />
					<Parameters >
						...
						<Parameter Category='Distance From Well Bottom' Name='Dispense distance' Value='7' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='WashedBeadPlate' />
