...
<Velocity11 file='Protocol_Data' md5sum='51180d6bd568db401b7f28948292baa5' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Mixing' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Mixing' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='WideBoreTips' />
			...
			<Pipette_Process Name='Mixing' >
				...
				<Task Name='Bravo::secondary::Set Head Mode' Task_Type='512' >
					...
					<TaskScript Name='TaskScript' Value='task.Headmode = pro.hmode;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,13-pro.cols]];' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WideBoreTips' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=vol.PRE_ASP' Value='5' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Shake' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='if(!pro.shake) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='WideBoreTips' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='samples' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=vol.mix' Value='10' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='0' />
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='1.75' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=vol.PRE_ASP' Value='10' />
						<Parameter Category='Volume' Name='Blowout volume' Value='0' />
