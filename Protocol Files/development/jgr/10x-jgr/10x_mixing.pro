...
<Velocity11 file='Protocol_Data' md5sum='296ba59619a709d9df41af8f29ea4570' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var settings = GetGlobalObject().settings;

var pro = {
	hmode: &quot;1,2,1,&quot;+settings.columns,
	shake: false
};

var vol = {
	PRE_ASP: 5,
	mix: settings.mixVolume
};
	' />
				</Task>
				<Plate_Parameters >
