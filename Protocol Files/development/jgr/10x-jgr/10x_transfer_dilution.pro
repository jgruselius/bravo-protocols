...
<Velocity11 file='Protocol_Data' md5sum='5dc7e5750c8d5e48cc78b839e5db16f4' version='2.0' >
...
var filePath = global.formFile;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var tm = new TransferManager(&quot;single_tip_dilution&quot;);
...
var expected;
if(typeof tm.current !== &quot;undefined&quot;) {
	expected = tm.current.sourcePlate;
} else {
...
task.Body = msg;' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='BARCODE MISMATCH' />
						<Parameter Category='' Name='Body' Value='' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='coolingOff' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='coolingOff' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='SIGNAL_TIPS' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
			...
			<Pipette_Process Name='coolingOff' >
				<Minimized >0</Minimized>
...
var vol = {};
vol.src = tm.getVolume();
vol.dil = tm.getDiluentVolume();
if(vol.src+vol.dil &gt; MAX_VOLUME) {
	print(&quot;WARNING: Combined volume of sample and buffer volume exceeds maximum tip capacity, skipping transfer.&quot;);
	vol = null;
}
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;654a1ada770430965f3bbc6f8b039728&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
	...
	var preAsp = 0;
	if(!vol.dil) { preAsp = 5; }
	task.Volume = (vol.src &lt;= MAX_VOLUME) ? vol.src : MAX_VOLUME;
...
&lt;/Velocity11&gt;' />
	...
	task.skip();
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;d682a365afa06018a9c99277666d708d&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;1&apos; RowCount=&apos;1&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;4&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;8&apos; Row=&apos;7&apos; /&gt;
