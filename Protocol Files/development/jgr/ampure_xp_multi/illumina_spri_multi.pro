...
<Velocity11 file='Protocol_Data' md5sum='8ea0312de2024a7fe817023b149b9eee' version='2.0' >
...
/*
var numPlates = global.formNumPlates || 4;
var columns = global.formColumns || 12;
...
var bindTime = testMode ? 1 : 1 * 60;
var elutionTime = testMode ? 1 : 1 * 60;
var ethanolDryTime = testMode ? 1 : 1 * 60;
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(plateInstance &lt;= numPlates) task.skip();
' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Wash' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Bind' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(plateInstance &lt;= numPlates) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='ReorderTips1' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(plateInstance &lt;= numPlates) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Elute' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Spawn Process' >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Wash' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(plateInstance &lt;= numPlates) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='ReorderTips2' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Elute' />
					<Parameter Name='Plate type' Value='96 Nunc Deep Well 1 mL' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='ReorderTips1' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='ReorderTips1' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Upstack' >
					<Devices >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='if(plateInstance &lt;= numPlates) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='WashTips' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='ReorderTips1' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='4' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
					<Parameter Name='Use single instance of plate' Value='0' />
					<Parameter Name='Automatically update labware' Value='0' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='ReorderTips2' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='ReorderTips2' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Upstack' >
					<Devices >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='ReorderTips2' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='4' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='Bind' >
				...
				<Task Name='BuiltIn::Loop' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=numPlates;' Value='1' />
						<Parameter Category='' Name='Change tips every N times, N = ' Value='1' />
					</Parameters>
					<Variables >
						<Variable fIncrement='1' iFreqValue='0' strFrequency='Every time' strInitialValue='1' strVariableName='plateInstance' />
					</Variables>
				</Task>
...
var mTransferVolume = beadVolume;
var mAspDistance = 1;
var mDispDistance = 1;
var mMixVolume = (0.8 * beadVolume &gt; MAX_MIX_VOLUME) ? MAX_MIX_VOLUME : 0.8 * beadVolume;
...
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Bind' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
task.Tiptouchretractdistance = dph(sampleVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='Bind' />
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='BindTips' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='Samples' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
...
task.Whichsidestousefortiptouch = &quot;None&quot;;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Elute' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='Elute' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='Elute' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='ElutionTips' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='FinalPlate' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='ReorderTips1' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='ReorderTips1' />
						<Parameter Category='' Name='Location to use, location' Value='3' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='ReorderTips1' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='ReorderTips2' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='ReorderTips2' />
						<Parameter Category='' Name='Location to use, location' Value='3' />
						<Parameter Category='' Name='Reservation time' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='ReorderTips2' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
			...
			<Pipette_Process Name='Wash' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='Wash' />
						<Parameter Category='' Name='Location to use, location' Value='7' />
...
var mPreAspVolume = PRE_ASP_LARGE;
var mTransferVolume = sampleVolume + beadVolume + 10;
...
task.Distancefromwellbottom = 50;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Wash' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='Wash' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Change Instance' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Plate to change' Value='WashTips' />
						<Parameter Category='' Name='Spawn control' Value='Spawn new plates when task runs ' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Loop End' >
