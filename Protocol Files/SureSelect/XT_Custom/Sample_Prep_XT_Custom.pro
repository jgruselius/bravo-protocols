...
<Velocity11 file='Protocol_Data' md5sum='f5578d8492eb2f97e273c822a45f0c49' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='print(&quot;The number of columns of samples is &quot; + columns_samples + &quot;.&quot;)

switch (plate_preparation_case){
    case &quot;ILMN XT: End Repair&quot;:
        mm_vol = 52;
        dna_vol = 48;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column = 1;
        mm_tips_column = 1;
        hyb_on_deck = true;
        inheco4_start_temp = 20;
        inheco6_start_temp = 4;
        inheco4_end_temp = 45;
        inheco6_end_temp = 20;
        reaction_plate_hyb_time = 1800;
        inheco4_end_state = &quot;On&quot;;
        inheco6_end_state= &quot;On&quot;;
        break;
    case &quot;ILMN XT: A-Tailing&quot;:
        mm_vol = 20;
        dna_vol = 30;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column = 2;
    ...
    case &quot;ILMN XT: Adapter Ligation&quot;:
        ...
        mm_tips_column = 3;
        hyb_on_deck = true;
        inheco4_start_temp = 23;
        inheco6_start_temp = 4;
        inheco4_end_temp = 45;
        inheco6_end_temp = 23;
        reaction_plate_hyb_time = 900;
        inheco4_end_state = &quot;On&quot;;
        inheco6_end_state= &quot;On&quot;;
        break;
    case &quot;ILMN XT: Pre-Capture PCR&quot;:
        mm_vol = 35;
        dna_vol = 15;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column = 4;
        ...
        inheco6_end_temp = 23;
        reaction_plate_hyb_time = 900;
        inheco4_end_state = &quot;Off&quot;;
        inheco6_end_state= &quot;Off&quot;;
        break;
    case &quot;SOLiD XT: End Repair&quot;:
        mm_vol = 71;
        dna_vol = 29;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column = 1;
        ...
        inheco6_end_state= &quot;On&quot;;
        break;
    case &quot;SOLiD XT: Adapter Ligation&quot;:
        mm_vol = 76;
        dna_vol = 24;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column = 2;
  ...
  case &quot;Manual Entry&quot;:
        mm_vol =  form_mm_vol
        dna_vol = form_dna_vol;
        reaction_vol = mm_vol + dna_vol;
        mm_source_column =form_mm_source_column;
		mm_tips_column = form_mm_tips_column
        hyb_on_deck = form_hyb_on_deck;
        inheco4_start_temp = form_inheco4_start_temp;
        inheco6_start_temp = form_inheco6_start_temp;
        inheco4_end_temp = form_inheco4_end_temp;
        inheco6_end_temp = form_inheco6_end_temp;
        reaction_plate_hyb_time = form_reaction_plate_hyb_time_min * 60;
        inheco4_end_state = form_inheco4_end_state;
		inheco6_end_state = form_inheco6_end_state;
        break;
}


print(&quot;The volumes used in this protocol are from case &quot; + plate_preparation_case)
...
' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = inheco4_start_temp' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='24' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = inheco6_start_temp' />
					<Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Incubate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='//real time is 30 minutes
if (hyb_on_deck) {
    task.Incubationtime = reaction_plate_inc_time
} else task.skip()' />
					<Parameters >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='Nunc = &quot;1&quot;
Collection = &quot;2&quot;
DNA_plate = &quot;1&quot;
spri_case = 1' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1, mm_tips_column]]' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var add_mm_column = 1' />
				</Task>
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , mm_source_column]]' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Master Mix Plate' />
						<Parameter Category='' Name='Location, location' Value='9' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=mm_vol' Value='52' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='
task.Wellselection = [[ 1 , add_mm_column ]]
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop End' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='add_mm_column++' />
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=dna_vol' Value='48' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='4' />
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if (reaction_vol &lt;= 185) {
    task.Volume = 0.8*reaction_vol
} else task.Volume = 150' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Reaction Plate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='if (inheco4_end_state == &quot;Off&quot;) task.Turnofftemperature = true
else if (inheco4_end_state == &quot;On&quot;){
    task.Turnofftemperature = false;
    task.Temperature = inheco4_end_temp;}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='24' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='if (inheco6_end_state == &quot;Off&quot;) task.Turnofftemperature = true
else if (inheco6_end_state == &quot;On&quot;){
    task.Turnofftemperature = false;
    task.Temperature = inheco6_end_temp;}' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
