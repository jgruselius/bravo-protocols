...
<Velocity11 file='Protocol_Data' md5sum='19fff4a22a76f90ee281e2e089e0404b' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\SureSelect\XT_Illumina\BravoMiniPHBenchCel_round_magnet.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open(&quot;C:\\VWorks Workspace\\Scripts\\SureSelect\\tiptracking.js&quot;)
...
Click &apos;Continue&apos; to resume protocol.' />
				...
				<Task Name='Inheco STC/MTC Controller::Set Temperature' >
					<Devices >
						<Device Device_Name='Bravo Position 6' Location_Name='Default Location' />
					</Devices>
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >1</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='373' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' Value='4' />
						<Parameter Category='' Name='Wait' Value='1' />
						<Parameter Category='' Name='Tolerance[+/-] &gt;= 0.0' Value='2' />
						<Parameter Category='' Name='Timeout' Value='10' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::User Message' >
			...
			<Process >
				...
				<Task Name='Inheco STC/MTC Controller::Set Temperature' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Tolerance[+/-] &gt;= 0.0' Value='0.5' />
						<Parameter Category='' Name='Timeout' Value='1' />
					</Parameters>
				</Task>
				<Plate_Parameters >
