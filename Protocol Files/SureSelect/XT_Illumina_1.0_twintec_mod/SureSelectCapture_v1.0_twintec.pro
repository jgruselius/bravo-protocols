...
<Velocity11 file='Protocol_Data' md5sum='20e294160bbe9dd33077cf348b59940d' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\SureSelect\XT_Illumina\BravoMiniPHBenchCel_round_magnet_wash.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open(&quot;C:\\VWorks Workspace\\Scripts\\SureSelect\\tiptracking.js&quot;)
...
The red adapter block must be installed on 4. The PCR plate will be transfered here in a few steps.' />
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Confirm that buffer 2 is at position 6 seated in the adapter and the Nunc with prepared beads is at position 5.

The red adapter block should be at position 4.
...
Retrieve Hybridization plate from thermocycler, and place in block at position 4 of the Bravo and unseal.
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove PCR plate from block at position 4.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
