...
<Velocity11 file='Protocol_Data' md5sum='11ccf9517f0e4d048fa5c8333d96d991' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\BravoMiniPHBenchCel_round_magnet_red4.dev' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='open(&quot;C:\\VWorks Workspace\\Scripts\\SureSelect\\file_operations.js&quot;)
...
Place DNA plate at position 5, Eppendorf PCR plate at position 6, and master mix plate (Eppendorf twin.tec) at position 9.
...
Put the red adapter block on position 4.
' />
						<Parameter Category='' Name='Only show the first time' Value='' />
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='PCR Plate' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='.15' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='.75' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove Eppendorf plate from position 4, seal and place in thermocycler.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
Leave DNA plate in thermocycler until you are instructed to transfer the plate.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
Retrieve DNA plate from thermocycler, and place in block at Bravo position 4 and unseal.

Click Continue to resume protocol.

CAUTION: Position 4 will be hot.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
