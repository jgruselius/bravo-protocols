...
<Velocity11 file='Protocol_Data' md5sum='307fdd8e6d497a0e9a49666c5ab05890' version='2.0' >
			...
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Set position 4 to 4C and position 6 to 37C.  

Confirm that appropriate amount of A-Tailing master mix is in column 2 of a NUNC plate.

Place DNA plate at position 3, reaction plate at position 4, and master mix plate at position 9.' />
...
task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Location to use, plate' Value='Reaction Plate' />
