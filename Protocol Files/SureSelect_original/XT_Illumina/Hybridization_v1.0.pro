...
<Velocity11 file='Protocol_Data' md5sum='a585c47a09654f36b8e928869a2693a1' version='2.0' >
...
open(&quot;C:\\VWorks Workspace\\Scripts\\SureSelect\\tiptracking.js&quot;)' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='When thermocycler has reached 65C click continue and be ready to transfer DNA plate from thermocycler to Bravo' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Put plates on Bravo' />
						<Parameter Category='' Name='Body' Value='Quickly retrieve DNA plate from thermocycler and place on Bravo position 4, remove seal and click continue.
...
Press Continue after plate is in thermocycler for protocol to finish.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
