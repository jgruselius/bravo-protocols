...
<Velocity11 file='Protocol_Data' md5sum='91c19f93bbd48d5246ca6677a4e4b465' version='2.0' >
...
' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Put the red adapter block on position 4. After acknowledging this message, position 4 will be set to 69C. There may be a pause for a few minutes while the position 4 comes to temperature.' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove plate from position 4, seal and place in thermocycler.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
