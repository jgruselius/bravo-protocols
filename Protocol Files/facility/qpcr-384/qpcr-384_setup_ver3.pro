...
<Velocity11 file='Protocol_Data' md5sum='95d6c69674cc795b58c87faa54d8a20f' version='2.0' >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var steps = Math.ceil(volume.buffer[0] / MAX_VOLUME);' />
				</Task>
				<Task Name='BuiltIn::Loop' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
