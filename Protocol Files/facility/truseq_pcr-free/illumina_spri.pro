...
<Velocity11 file='Protocol_Data' md5sum='7d73bbdc1d1960595a2e4eb1c116ab4b' version='2.0' >
		...
		<Main_Processes >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(finalHold || (!finalHold &amp;&amp; !sealFinalPlate &amp;&amp; !doCentrifuge)) task.skip();' />
					<Parameters >
