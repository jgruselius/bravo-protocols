...
<Velocity11 file='Protocol_Data' md5sum='569cfb3f3fe115e98c49979094eeea4e' version='2.0' >
...
var vol_sample = 50;
// The column where the end-repair reaction mix
// is located in the master mix plate:
var col_er_mix = 1;
// Volume of end-repair reaction mix (uL):
var vol_er_mix = 50;
// End repair reaction incubation temperature (deg C):
// To compensate for panel-plate temperature differences
// the set temperature have been calibrated to:
var temp_er = 39; // Actual reaction temperature: 30C
// End repair reaction incubation time (min):
var time_er = 30 * 60 * time_mod;

global.statusString = &quot;End repair started&quot;;' />
					<Parameters >
...
//plate.labware = platetype_sample;' />
				...
				<Task Name='BuiltIn::Incubate' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Incubationtime = time_er;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='0' />
						<Parameter Category='Task Description' Name='Task description' Value='' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='plate_er' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='tips_er' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='tips_er' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<TaskScript Name='TaskScript' Value='// First column of tips:
task.Wellselection = [[1,col_er_mix]];' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[1,col_er_mix]];
task.Volume = vol_er_mix;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_mastermix' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
task.Volume = vol_er_mix;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_er' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
task.Wellselection = [[1,13-col_er_mix]];' />
					<Parameters >
...
task.skip();' />
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Task description' Value='' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Location to use, plate' Value='plate_er' />
...
task.skip();' />
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = temp_er;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
						<Parameter Category='' Name='Temperature' TaskParameterScript='=temp_er;' Value='' />
						<Parameter Category='' Name='Wait' Value='1' />
						<Parameter Category='' Name='Temperature Tolerance' Value='1' />
						<Parameter Category='' Name='Timeout' Value='10' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Tips On' Task_Type='16' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='tips_er' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='var mix_vol = 0.8 * (vol_sample + vol_er_mix);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.9 * vol_sample;
task.Dynamictipretraction = 4 / (0.9 * vol_sample)' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='plate_er' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Set CA purification protocol paramters:
global.updateSettings(&quot;end_repair&quot;);
global.statusString = &quot;End repair completed&quot;;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='0' />
						<Parameter Category='Task Description' Name='Task description' Value='' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
