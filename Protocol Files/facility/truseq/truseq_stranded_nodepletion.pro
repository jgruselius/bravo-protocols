...
<Velocity11 file='Protocol_Data' md5sum='5ded1f10e0ec58fef98efb02dcaaf345' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='//author Chuan Wang, version 160406
...
//number of columns
//var columns = parseInt(user_entry);
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='AddFragBuffer' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='AddFragBuffer' />
					</Parameters>
				</Task>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_RemoveTipBox_Frag' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='TipBox_Frag' />
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Distribute1strand' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Distribute1strand' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Distribute2strand' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Distribute2strand' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='BufferPlate' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_Remove_Waste_TipBox_Frag' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Remove the plate in position 4. Seal, transfer to a thermocycler and run the mRNA fragmentation program. Click &quot;Continue&quot; when incubation has started. The incubation will take 5 minutes. Standby for the 1st strand synthesis.' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='TipBox_1strand' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_1strandBuffDistributed' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='When thermocycler run is finsihed, unseal and return the plate to position 4. Also inspect that 1st strand synthesis buffer has been aliquoted to all wells to run in the plate on position 5. Click &quot;Continue&quot; when these steps have been completed.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_FragmentedSample' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_RemoveSamplePlate' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='FirstStrand' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_1strandBuffDistributed' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_FragmentedSample' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='TipBox_1strand' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_RemoveSamplePlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate transfer' />
						<Parameter Category='' Name='Body' Value='Remove the plate in position 4. Seal, transfer to a thermocycler and run the cDNA first strand synthesis program. Seal the Deep well nunc plate with reagents on position 9 and store it in 4튏. Click &quot;Continue&quot; when incubation has started.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate transfer' />
						<Parameter Category='' Name='Body' Value='When thermocycler run is finsihed, unseal and return the plate to position 4. Also unseal and return the deep well nunc plate with reagents to position 9. Click &quot;Continue&quot; when these steps have been completed.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='TipBox_2strand' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_SecondStrandBuffer' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Transfer1strandsample' />
						<Parameter Category='Static labware configuration' Name='Display confirmation' Value='Don&apos;t display' />
						<Parameter Category='Static labware configuration' Name='1' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='2' Value='&lt;use default&gt;' />
						<Parameter Category='Static labware configuration' Name='3' Value='&lt;use default&gt;' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Transfer1strandsample' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Upstack' >
					<Devices >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_RemoveFirstStrandPlate' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='FirstStrand' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_RemoveTipBox_Frag' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_Remove_Waste_TipBox_Frag' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Waste_TipBox_Frag' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='SecondStrand' />
						<Parameter Category='' Name='Spawn as subroutine' Value='' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_SecondStrandPlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_SecondStrandBuffer' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_RemoveFirstStrandPlate' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_RemoveTipBox_2strand' />
					</Waitfors_To_Signal>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='TipBox_2strand' />
					<Parameter Name='Plate type' Value='96 V11 LT250 Tip Box 19477.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Process >
				...
				<Task Name='BuiltIn::Signal' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Waitfors_To_Signal >
						<Waitfor Name='Waitfor_SecondStrandPlate' />
					</Waitfors_To_Signal>
				</Task>
				<Task Name='Bravo::SubProcess' >
					<Enable_Backup >0</Enable_Backup>
				...
				<Task Name='BuiltIn::Wait For' Waitfor='Waitfor_RemoveTipBox_2strand' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Plate transfer' />
						<Parameter Category='' Name='Body' Value='Remove the plate in position 5. Seal, transfer to a thermocycler and run the cDNA second strand synthesis program. The leftover tips (if any) in MiniHub cassette 1 slot 1 are unused. Click &quot;Continue&quot; when incubation has started.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='0' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
					</Parameters>
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='SecondStrand' />
					<Parameter Name='Plate type' Value='96 Eppendorf Twin.tec PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='AddFragBuffer' >
				<Minimized >0</Minimized>
...
var mSourceColumn = 1;
var mNumberColumns = columns;
var mNumberSteps = mNumberColumns;
var mGetTips = true;
var mReturnTips = true;
var mFragBuffPosition = [[1,1]];
...
var mTouchRetract = -6;
var mMixVolume = 0.8*(vol_starting_sample+vol_frag);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='single_col_tips_on++;
single_col_tips_off++;' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=mNumberSteps' Value='mNumberSteps' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox_Frag' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = mFragBuffPosition;
task.Volume = mTransferVolume;
task.Liquidclass = mLiquidClass;
task.Distancefromwellbottom = mAspDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Wellselection = [[ 1 , block_mix ]];
task.Volume = mTransferVolume;
task.Liquidclass = mLiquidClass;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = mMixVolume;
task.Dynamictipretraction = 4 / mMixVolume;
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Waste_TipBox_Frag' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Distribute1strand' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox_1strand' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
...
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FirstStrand' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Distribute2strand' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='TipBox_2strand' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;217d6541f0816e6df6d7254a17460a16&apos; version=&apos;1.0&apos; &gt;
...
task.Distancefromwellbottom = mDispDistance;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SecondStrand' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='Transfer1strandsample' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::Group Begin' >
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
...
var mTransferVolume = (vol_frag + vol_starting_sample + vol_synth1);
var mAspDistance = 0.25;
var mDispDistance = 3;

var mMixVolume = 0.6 * (vol_synth2 + vol_frag + vol_starting_sample + vol_synth1);
...
&lt;/Velocity11&gt;' />
   ...
   task.skip();
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Allow automatic tracking of tip usage' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;8b654430d2d1ac6fd81c5516d8dc166b&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;1&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;4&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;2&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
		&lt;Wells &gt;
			&lt;Well Column=&apos;8&apos; Row=&apos;0&apos; /&gt;
		&lt;/Wells&gt;
	&lt;/WellSelection&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.8 * (vol_synth2 + vol_frag + vol_starting_sample + vol_synth1);
task.Liquidclass = &quot;j_slow_medium_vol&quot;;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.8 * (vol_synth2 + vol_frag + vol_starting_sample + vol_synth1);
task.Dynamictipretraction = 4 / (0.8 * (vol_synth2 + vol_frag + vol_starting_sample + vol_synth1));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SecondStrand' />
...
var mLiquidClass = &quot;j_slow_small_vol&quot;;
var mPreAspVolume = 20;
var mTransferVolume = (vol_frag + vol_starting_sample);
var mAspDistance = 0.25;
var mDispDistance = 3;

var mMixVolume = 0.6 * (vol_synth1 + vol_frag + vol_starting_sample);
var mMixLiquidClass = &quot;j_slow_mixing&quot;;
var mMixCycles = 8;
var mMixAspDistance = 0.7;
var mMixDispDistance = 3;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.8 * (vol_synth1 + vol_frag + vol_starting_sample);
task.Liquidclass = &quot;j_slow_medium_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FirstStrand' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='// Remove bubbles
task.Volume = 0.8 * (vol_synth1 + vol_frag + vol_starting_sample);
task.Dynamictipretraction = 4 / (0.8 * (vol_synth1 + vol_frag + vol_starting_sample));
task.Liquidclass = &quot;j_slow_small_vol&quot;;
task.Distancefromwellbottom = 0.25;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='FirstStrand' />
