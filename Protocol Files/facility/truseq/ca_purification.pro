...
<Velocity11 file='Protocol_Data' md5sum='182131a25b6735f4e3b82100283fcf76' version='2.0' >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(dilutionVolume &gt; 0) {
	task.Location_plate = &quot;ElutionBufferPlate&quot;;
} else if(!transferSample) {
	task.Location_plate = &quot;BeadPlate&quot;;
}
task.Volume = preAsp;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='if(!dilutionVolume) task.skip(); ' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='ElutionBufferPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=dilutionVolume;' Value='' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(!dilutionVolume) {
	task.skip();
} else if(!transferSample) {
	task.Location_plate = &quot;BeadPlate&quot;;
}
sampleVolume += dilutionVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='SamplePlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
						<Parameter Category='Volume' Name='Volume' TaskParameterScript='=dilutionVolume;' Value='10' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='if(maxAspVolume - rinseVolume - 4 &lt;= 0) task.skip();
task.Volume = maxAspVolume - rinseVolume - 4;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Waste' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Empty tips' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<TaskScript Name='TaskScript' Value='if(maxAspVolume - rinseVolume - 10 &lt;= 0) task.skip();
task.Volume = maxAspVolume - rinseVolume - 10;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Waste' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
