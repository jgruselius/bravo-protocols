...
<Velocity11 file='Protocol_Data' md5sum='3ae181fb73e1f99e223138f118f8ccb9' version='2.0' >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Check plate' />
						<Parameter Category='' Name='Body' Value='Confirm that all wells of the plate in position 5 contain ligation mix then return it and choose &apos;Continue&apos;.' />
