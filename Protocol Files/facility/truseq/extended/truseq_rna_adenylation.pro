...
<Velocity11 file='Protocol_Data' md5sum='43620f06e8ff11d99e98bacfdc4609f3' version='2.0' >
...
// Optional pause to allow delayed placement of reagents:
var reagentPause = global.reagentPause;
...
//plate.labware = platetype_sample;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if(!reagentPause) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Place reagents' />
						<Parameter Category='' Name='Body' Value='Confirm reagent plate has been place on Bravo-9 and index plate in MiniHub 1:5.' />
