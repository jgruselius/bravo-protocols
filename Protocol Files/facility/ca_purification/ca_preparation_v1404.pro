...
<Velocity11 file='Protocol_Data' md5sum='33d956c22c658430f3467a04ae2ce6e8' version='2.0' >
...
volume.elution = parseFloat(global.formElutionVolume) + 150; // Add 150 for bead wash
