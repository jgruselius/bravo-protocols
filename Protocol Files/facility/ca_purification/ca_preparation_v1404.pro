...
<Velocity11 file='Protocol_Data' md5sum='32e2af736be43b9e75c8328623f8ff5e' version='2.0' >
...
volume.elution = parseFloat(global.formElutionVolume) + 150 + 5*80 + formResuspVolume; // Add 150 for bead wash, 5*80 for tips wash
