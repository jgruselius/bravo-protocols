...
<Velocity11 file='Protocol_Data' md5sum='816eab459eda753f4644ab47256bb382' version='2.0' >
	<File_Info AllowSimultaneousRun='0' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='1' AutomaticallyLoadFormFile='0' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\SureSelect\XT_Illumina\BravoMiniPHBenchCel_round_magnet.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
...
var maxAspVolume = 160;
// Max volume to use when mixing:
var maxMixVolume = 140;
...
print(vars);' />
				...
				<Task Name='Bravo::Set temperature - Position' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = roomTemperature;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='var totalColumns = columnsOfSamples - 1;
var currentColumn = 1;
var mixVolume;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='0' />
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='if(columnsOfSamples == 1) {
   task.skip();
}' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=totalColumns;' Value='' />
...
mixVolume = 0.8 * beadVolume * (columnsOfSamples - currentColumn + 1);
task.Volume = (mixVolume &gt; maxMixVolume)  ? maxMixVolume : mixVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='' />
...
task.Wellselection = [[1,1+currentColumn]];
task.Volume = beadVolume;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = sampleVolume + 3;' />
					<Parameters >
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Shake' Task_Type='1024' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location, location' Value='5' />
						<Parameter Category='' Name='Mode' Value='On' />
						<Parameter Category='' Name='RPM' Value='1500' />
						<Parameter Category='' Name='Direction' Value='NWSE' />
						<Parameter Category='' Name='Time for operation in Timed mode' Value='10' />
						<Parameter Category='' Name='Allow concurrent operation' Value='0' />
						<Parameter Category='Task Description' Name='Task number' Value='0' />
...
var mTimerCycles = 5;
var mMixVolume = (precipVolume &lt; 150) ? precipVolume : 150;
var mAspDistance = 1;
var mDispDistance = 1;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='51' />
					</Advanced_Settings>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume =(beadVolume&lt;120) ? (beadVolume + 50) : (170 - beadVolume);
task.Preaspiratevolume = preAsp;' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='BeadPlate' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='task.Volume = beadVolume + 5;
...
&lt;/Velocity11&gt;' />
			...
			<Pipette_Process Name='TransferEluate' >
				...
				<Task Name='Bravo::secondary::Set temperature - Position' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='task.Temperature = finalTemperature;' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='4' />
						<Parameter Category='' Name='Turn off temperature' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Move To Location' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='if(elutionVolume &gt; 24) task.skip();' />
					<Parameters >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='if(elutionVolume &gt; 24) task.skip();' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Spin down' />
						<Parameter Category='' Name='Body' Value='Take the Nunc plate from position 7 and spin down for 5 s. Return the plate and click &apos;Continue&apos;.' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Blowout volume' Value='' />
						<Parameter Category='Properties' Name='Liquid class' Value='j_normal_medium_vol' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='3.8' />
						<Parameter Category='Properties' Name='Dynamic tip retraction' Value='0' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='South/North' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='5' />
...
task.Dynamictipretraction = 4 / (elutionVolume * 0.9);' />
					<Parameters >
						...
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='1' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='-3.3' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6d9e778ac7f7235a77c7705582d38a22&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
...
aspRepeats =Math.ceil((beadWashVolume + preAsp + 5) / maxAspVolume);
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::JavaScript' >
					...
					<TaskScript Name='TaskScript' Value='// Each transfer may have to be done in 
// more than one step if volume is large
aspRepeats =Math.ceil((dnaWashVolume + preAsp + 5) / maxAspVolume);
		...
		<Cleanup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='2862' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
