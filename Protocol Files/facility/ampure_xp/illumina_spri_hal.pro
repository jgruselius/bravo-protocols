...
<Velocity11 file='Protocol_Data' md5sum='e7db52e574ee4db26da5b4e9b4185bb9' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\Device Files\Bravo 96LT magnet.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' Notes='' PipettePlatesInInstanceOrder='1' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
			...
			<Pipette_Process Name='elute' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location to use, location' Value='2' />
...
var mPreAspVolume = PRE_ASP_LARGE;
var mTransferVolume = elutionVolume + 2;
var mAspDistance = 1;
...
var protocolName = &quot;AMPure XP purification&quot;;
